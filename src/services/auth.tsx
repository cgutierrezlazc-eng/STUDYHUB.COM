...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const updateProfile = async (data: Partial<User>) => {
    ...
    try {
      ...
      if ((data as any).languageSkill !== undefined)
        payload.language_skill = (data as any).languageSkill;
      ...
      if ((data as any).academicStatus !== undefined)
        payload.academic_status = (data as any).academicStatus;
      if ((data as any).offersMentoring !== undefined)
        payload.offers_mentoring = (data as any).offersMentoring;
      if ((data as any).mentoringServices !== undefined)
        payload.mentoring_services = (data as any).mentoringServices;
      if ((data as any).mentoringSubjects !== undefined)
        payload.mentoring_subjects = (data as any).mentoringSubjects;
      if ((data as any).professionalTitle !== undefined)
        payload.professional_title = (data as any).professionalTitle;
      if ((data as any).mentoringDescription !== undefined)
        payload.mentoring_description = (data as any).mentoringDescription;
      if ((data as any).mentoringPriceType !== undefined)
        payload.mentoring_price_type = (data as any).mentoringPriceType;
      if ((data as any).mentoringPricePerHour !== undefined)
        payload.mentoring_price_per_hour = (data as any).mentoringPricePerHour;
      if ((data as any).graduationStatusYear !== undefined)
        payload.graduation_status_year = (data as any).graduationStatusYear;
      if ((data as any).titleYear !== undefined) payload.title_year = (data as any).titleYear;
      if ((data as any).studyStartDate !== undefined)
        payload.study_start_date = (data as any).studyStartDate;
      ...
      if ((data as any).platformLanguage !== undefined)
        payload.platform_language = (data as any).platformLanguage;
      if ((data as any).secondaryLanguages !== undefined)
        payload.secondary_languages = (data as any).secondaryLanguages;
      if ((data as any).emailNotifEnabled !== undefined)
        payload.email_notif_enabled = (data as any).emailNotifEnabled;
      if ((data as any).emailNotifFriendPosts !== undefined)
        payload.email_notif_friend_posts = (data as any).emailNotifFriendPosts;
      if ((data as any).emailNotifFriendRequests !== undefined)
        payload.email_notif_friend_requests = (data as any).emailNotifFriendRequests;
      if ((data as any).emailNotifDirectMessages !== undefined)
        payload.email_notif_direct_messages = (data as any).emailNotifDirectMessages;
