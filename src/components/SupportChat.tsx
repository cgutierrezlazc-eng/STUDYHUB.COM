...
const ADMIN_CATS: Category[] = [
  {
    ...
    subs: [
      { id: 'contratos', label: 'Contratos', message: 'Necesito ayuda con contratos de trabajo' },
      {
        id: 'vacaciones',
        label: 'Vacaciones',
        message: 'Tengo una consulta sobre vacaciones y días libres',
      },
      {
        id: 'licencias',
        label: 'Lic. médicas',
        message: 'Necesito info sobre licencias médicas y permisos',
      },
      { id: 'finiquitos', label: 'Finiquitos', message: 'Quiero calcular o procesar un finiquito' },
      {
        id: 'incorporar',
        label: 'Incorporar',
        message: 'Quiero incorporar un nuevo trabajador a la empresa',
      },
    ],
  },
  {
    ...
    subs: [
      {
        id: 'liquidacion',
        label: 'Liquidaciones',
        message: 'Ayúdame con las liquidaciones de sueldo del mes',
      },
      { id: 'anticipo', label: 'Anticipos', message: 'Necesito info sobre anticipos quincenales' },
      {
        id: 'afp',
        label: 'AFP / Salud',
        message: 'Tengo dudas sobre retenciones de AFP y salud previsional',
      },
    ...
    subs: [
      {
        id: 'indicadores',
        label: 'UF / UTM',
        message: '¿Cuáles son los indicadores económicos actuales (UF, UTM, dólar)?',
      },
    ...
    subs: [
      {
        id: 'obligaciones',
        label: 'Obligaciones',
        message: 'Muéstrame las obligaciones del empleador',
      },
      {
        id: 'normativa',
        label: 'Normativa',
        message: 'Tengo dudas sobre normativa laboral chilena',
      },
      {
        id: 'documentos',
        label: 'Generar doc',
        message: 'Necesito generar un documento legal (contrato, memo, carta)',
      },
    ],
  },
  {
    ...
    subs: [
      {
        id: 'usuarios',
        label: 'Usuarios',
        message: 'Necesito gestionar usuarios de la plataforma',
      },
      { id: 'reportes', label: 'Reportes', message: 'Quiero generar un reporte de la plataforma' },
      {
        id: 'config',
        label: 'Configuración',
        message: 'Tengo dudas sobre la configuración del sistema',
      },
    ],
  },
];
    ...
    subs: [
      {
        id: 'avance',
        label: 'Mi avance',
        message: '¿En qué cursos estoy y cuál es mi avance actual?',
      },
  ...
  },
  {
    ...
    subs: [
      { id: 'practicar', label: 'Practicar', message: 'Quiero hacer un quiz de práctica' },
      {
        ...
        message: '¿Cómo me ha ido en los quizzes anteriores?',
      },
      {
        id: 'flashcards',
        label: 'Flashcards',
        message: '¿Cuántas flashcards tengo pendientes de repasar hoy?',
      },
    ],
  },
  {
    ...
    subs: [
      {
        id: 'mis-docs',
        label: 'Mis archivos',
        message: '¿Qué documentos he subido a la plataforma?',
      },
      {
        id: 'apuntes',
        label: 'Apuntes',
        message: '¿Cómo organizo mis apuntes y materiales de estudio?',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subs: [
      ...
      { id: 'cv', label: 'Mi CV', message: '¿Cómo está mi perfil profesional y CV?' },
      {
        id: 'suscripcion',
        label: 'Suscripción',
        message: '¿Cuál es mi plan activo y qué incluye?',
      },
    ],
  },
  {
    ...
    subs: [
      {
        id: 'ofertas',
        label: 'Ver ofertas',
        message: '¿Qué ofertas de trabajo hay disponibles ahora?',
      },
      ...
      { id: 'mis-apps', label: 'Mis postulaciones', message: '¿A qué ofertas he postulado?' },
      {
        ...
        message: '¿Cómo está mi perfil laboral y qué puedo mejorar?',
      },
    ],
  },
];
...
export default function SupportChat() {
  ...
  const theme = isAdmin
    ? {
        gradient: 'linear-gradient(135deg, #1E0A4E 0%, #3B0E8C 50%, #5B21B6 100%)',
        shadow: 'rgba(30,10,78,0.55)',
        shadowHover: 'rgba(30,10,78,0.7)',
        btnFill: 'rgba(167,139,250,0.2)',
        accent: '#5B21B6',
      }
    : {
        gradient: 'linear-gradient(135deg, #5B21B6 0%, #7C3AED 60%, #A78BFA 100%)',
        shadow: 'rgba(124,58,237,0.4)',
        shadowHover: 'rgba(124,58,237,0.55)',
        btnFill: 'rgba(255,255,255,0.2)',
        accent: '#7C3AED',
      };
  ...
  useEffect(() => {
    ...
    if (!isAdmin) {
      setMessages([
        {
          role: 'assistant',
          content: `Hola${user?.firstName ? `, ${user.firstName}` : ''}! Soy Konni, tu asistente personal de estudio. ¿En qué te puedo ayudar?`,
        },
      ]);
    }
  }, [isAdmin]);
  ...
  const sendMessage = async (text: string) => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...
        {
          role: 'assistant',
          content: 'Ups, algo salió mal. Intenta de nuevo o escribe a contacto@conniku.com.',
        },
      ]);
    }
    setLoading(false);
      ...
      >
        <button
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.boxShadow = `0 6px 24px ${theme.shadowHover}`;
          }}
          onMouseLeave={(e) => {
  ...
  const header = (
    ...
    >
      ...
      <div style={{ flex: 1 }}>
        <div
          style={{ fontWeight: 700, fontSize: 14, display: 'flex', alignItems: 'center', gap: 6 }}
        >
          ...
          {!isAdmin && detectedMode && (
            <span
              style={{
                ...
                borderRadius: 20,
                background:
                  detectedMode === 'academic' ? 'rgba(251,191,36,0.22)' : 'rgba(255,255,255,0.18)',
      ...
      >
        ...
        <div style={{ padding: '12px 16px', borderTop: '1px solid var(--border)', flexShrink: 0 }}>
          <button
            onClick={() =>
              enterAdminChat(
                `Hola${user?.firstName ? `, ${user.firstName}` : ''}! Soy Konni Admin, tu asistente ejecutivo. ¿En qué te puedo ayudar hoy?`
              )
            }
            style={{
              width: '100%',
            ...
            <React.Fragment key={i}>
              <div
                style={{
                  ...
                  background: msg.role === 'user' ? theme.gradient : 'var(--bg-secondary)',
        ...
        >
          ...
          >
            ...
            <polygon
              ...
              fill={input.trim() ? 'rgba(255,255,255,0.2)' : 'none'}
            />
          </svg>
        </button>
      </div>
