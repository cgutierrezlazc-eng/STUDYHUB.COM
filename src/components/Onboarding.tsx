...
const STEP_CONFIG = [
  {
    icon: Smile({ size: 36 }),
    color: '#f59e0b',
    titleKey: 'onb.welcomeTitle',
    descKey: 'onb.welcomeDesc',
  },
  {
    icon: Home({ size: 36 }),
    color: '#2563eb',
    titleKey: 'onb.dashboardTitle',
    descKey: 'onb.dashboardDesc',
  },
  {
    icon: BookOpen({ size: 36 }),
    color: '#16a34a',
    titleKey: 'onb.subjectsTitle',
    descKey: 'onb.subjectsDesc',
  },
  {
    icon: Users({ size: 36 }),
    color: '#8b5cf6',
    titleKey: 'onb.communitiesTitle',
    descKey: 'onb.communitiesDesc',
  },
  {
    icon: MessageSquare({ size: 36 }),
    color: '#06b6d4',
    titleKey: 'onb.messagingTitle',
    descKey: 'onb.messagingDesc',
  },
  {
    icon: Briefcase({ size: 36 }),
    color: '#ea580c',
    titleKey: 'onb.jobsTitle',
    descKey: 'onb.jobsDesc',
  },
  {
    icon: Sparkles({ size: 36 }),
    color: '#2563eb',
    titleKey: 'onb.readyTitle',
    descKey: 'onb.readyDesc',
  },
];
  ...
  return (
    <div className="onb-overlay">
      <div className="onb-card">
        ...
        <button className="onb-skip" onClick={() => handleComplete()}>
          {t('onb.skipTour')}
        </button>
      </div>
    </div>
