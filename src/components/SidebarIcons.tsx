...
───────────────────────────────────────────────────────────────────── */
interface IconProps { color: string; children: React.ReactNode }
...
export const Icons = {
  user: (c: string) => (
    <Icon color={c}>
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round">
  ...
  community: (c: string) => (
    <Icon color={c}>
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round">
        <circle cx="9" cy="7" r="4" fill="white" fillOpacity={0.20}/>
  ...
  calendar: (c: string) => (
    <Icon color={c}>
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round">
        ...
        <rect x="7" y="14" width="3.5" height="3.5" rx="0.5" fill="white" fillOpacity={0.30}/>
      </svg>
    </Icon>
  ),
  compass: (c: string) => (
    <Icon color={c}>
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round">
        <circle cx="12" cy="12" r="10" fill="white" fillOpacity={0.15}/>
        <polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76" fill="white" fillOpacity={0.28}/>
      </svg>
    </Icon>
  ),
  messageCircle: (c: string) => (
    <Icon color={c}>
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round">
        <path d="M20 2H4a1 1 0 00-1 1v13a1 1 0 001 1h3l4 4 4-4h5a1 1 0 001-1V3a1 1 0 00-1-1z" fill="white" fillOpacity={0.20}/>
      </svg>
    </Icon>
  ),
  barChart: (c: string) => (
  ...
  video: (c: string) => (
    <Icon color={c}>
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round">
        <rect x="1" y="5" width="15" height="14" rx="2" fill="white" fillOpacity={0.20}/>
  ...
  fileText: (c: string) => (
    <Icon color={c}>
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round">
        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" fill="white" fillOpacity={0.18}/>
  ...
  diploma: (c: string) => (
    <Icon color={c}>
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M10 22l-1 2"/><path d="M14 22l1 2"/>
      </svg>
    </Icon>
  ),
  tutors: (c: string) => (
  ...
  diamond: (c: string) => (
    <Icon color={c}>
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round">
        <path d="M6 3h12l4 6-10 13L2 9z" fill="white" fillOpacity={0.20}/>
        <path d="M2 9h20"/>
      </svg>
    </Icon>
  ),
  lightbulb: (c: string) => (
    <Icon color={c}>
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round">
        <path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5A4.61 4.61 0 0 1 8.91 14" fill="white" fillOpacity={0.18}/>
  ...
  book: (c: string) => (
    <Icon color={c}>
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" fill="white" fillOpacity={0.18}/>
  ...
  sparkles: (c: string) => (
    <Icon color={c}>
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2l2.4 7.2L22 12l-7.6 2.8L12 22l-2.4-7.2L2 12l7.6-2.8L12 2z" fill="white" fillOpacity={0.20}/>
      </svg>
    </Icon>
  ),
  home: (c: string) => (
    <Icon color={c}>
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round">
        <path d="M3 9.5L12 3l9 6.5V21a1 1 0 01-1 1H15v-6H9v6H4a1 1 0 01-1-1V9.5z" fill="white" fillOpacity={0.22}/>
      </svg>
    </Icon>
  ),
}
