          ...
          {showSuggestions && (
            <div className="search-suggestions">
              ...
              {searchQuery.trim().length >= 2 && (
                <>
                  {sugLoading && (
                    <div className="search-sug-label" style={{ textAlign: 'center', padding: 12 }}>
                      {t('topbar.searching')}
                    </div>
                  )}
                  ...
                  >
                    ...
                    <span>
                      {t('topbar.searchWeb')} "{searchQuery}"
                    </span>
                  </button>
                </>
              )}
          ...
          >
            <div
              style={{
                ...
                borderRadius: '50%',
                background: '#22c55e',
                animation: 'conniku-pulse 2s infinite',
              }}
            />
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '20px' }}>
                ...
                {user?.provider === 'email' ? (
                  !pwShowChange ? (
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                      ...
                      {pwError && (
                        <p style={{ color: 'var(--accent-red, #dc2626)', fontSize: 13, margin: 0 }}>
                          {pwError}
                        </p>
                      )}
                      {pwSuccess && (
                        <p
                          style={{ color: 'var(--accent-green, #16a34a)', fontSize: 13, margin: 0 }}
                        >
                  ...
                  <p style={{ fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.5 }}>
                    Iniciaste sesión con Google. Para cambiar tu contraseña, hazlo desde tu cuenta
                    de Google.
                  </p>
                )}
              </div>
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
                  ...
                  <span
                    style={{ fontWeight: 700, fontSize: 14, color: 'var(--accent-red, #dc2626)' }}
                  >
                    Zona de Peligro
                  </span>
                </div>
                ...
                >
                  Eliminar tu cuenta es una acción permanente e irreversible. Se borrarán todos tus
                  datos.
                </p>
                {!showDeleteConfirm ? (
                  <button
