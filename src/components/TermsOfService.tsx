    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal" onClick={e => e.stopPropagation()} style={{ maxWidth: 760, maxHeight: '90vh', overflowY: 'auto' }}>
        ...
        <div style={{ fontSize: 14, lineHeight: 1.85, color: 'var(--text-secondary)' }}>
          ...
          <p><strong>a) Plan Básico (Gratuito):</strong> Acceso limitado. Hasta 2 asignaturas activas, 20 consultas al asistente cada 6 horas, 300 MB de almacenamiento. Visualización de documentos sin opción de descarga.</p>
          <p><strong>b) Plan Pro (USD $5/mes o USD $39.99/año):</strong> Hasta 8 asignaturas, 200 consultas diarias al asistente, 1 GB de almacenamiento, descarga de documentos, exportación a Word (hasta 1,500 palabras), modo socrático, predictor de examen, flashcards FSRS, creación de comunidades, +20% de bonificación en XP.</p>
          ...
          <p>20.3. Conniku cumple con: (a) la Ley N° 19.628 sobre Protección de la Vida Privada de Chile; (b) la Ley N° 21.096 que consagra la protección de datos personales como garantía constitucional en Chile; (c) el Reglamento General de Protección de Datos (RGPD/GDPR) de la Unión Europea — Reglamento (UE) 2016/679, en cuanto sea aplicable a usuarios europeos; (d) la Ley Federal de Protección de Datos Personales en Posesión de los Particulares (LFPDPPP) de México; (e) la Lei Geral de Proteção de Dados Pessoais (LGPD) — Lei N° 13.709/2018, de Brasil; (f) la California Consumer Privacy Act (CCPA) y la California Privacy Rights Act (CPRA), en cuanto sea aplicable a residentes de California, EE.UU.; (g) la Ley N° 25.326 de Protección de Datos Personales de Argentina; y (h) las regulaciones de protección de datos aplicables en cada jurisdicción donde opera la Plataforma.</p>
          <p>20.4. El Usuario tiene derecho a acceder, rectificar, cancelar y oponerse al tratamiento de sus datos personales (derechos ARCO) en cualquier momento, mediante solicitud dirigida a <strong>privacidad@conniku.com</strong>.</p>
          <p>20.5. <strong>Derechos adicionales según jurisdicción:</strong></p>
          <ul style={{ paddingLeft: 20, marginBottom: 14 }}>
            <li><strong>Usuarios de la UE / EEE (GDPR):</strong> además de los derechos ARCO, tienen derecho a la portabilidad de datos (Art. 20), limitación del tratamiento (Art. 18), supresión ("derecho al olvido", Art. 17), oposición (Art. 21) y a no ser objeto de decisiones exclusivamente automatizadas (Art. 22). Plazo de respuesta: 30 días (prorrogable a 60). Pueden presentar reclamación ante la Autoridad de Control de su Estado miembro.</li>
            <li><strong>Usuarios de Brasil (LGPD Art. 18):</strong> tienen derecho a confirmar el tratamiento, acceder, corregir, anonimizar, bloquear, eliminar, solicitar portabilidad, conocer el compartimiento con terceros y revocar el consentimiento. Pueden acudir a la ANPD (Autoridade Nacional de Proteção de Dados).</li>
            <li><strong>Residentes de California (CCPA/CPRA):</strong> tienen derecho a saber, eliminar, corregir y optar por no participar en la venta/compartimiento de datos (Conniku no vende datos personales). Derecho a no ser discriminado por ejercer sus derechos. Plazo de respuesta: 45 días (prorrogable 45 días adicionales).</li>
            <li><strong>Usuarios de México (LFPDPPP):</strong> derechos ARCO ante Conniku y recurso ante el INAI.</li>
          </ul>
          <p>20.6. Para el ejercicio de cualquier derecho de privacidad, independientemente de la jurisdicción, el canal unificado es <strong>privacidad@conniku.com</strong>. La Política de Privacidad (disponible en conniku.com/privacidad) contiene el detalle completo de los derechos por jurisdicción y los mecanismos de transferencia internacional de datos.</p>
          ...
          <p>36.4. Las respuestas del asistente de Conniku son de carácter orientativo y pueden contener imprecisiones. Conniku no garantiza la exactitud, completitud ni idoneidad de dichas respuestas. El Usuario asume la responsabilidad de verificar la información proporcionada por el asistente antes de tomar decisiones basadas en ella.</p>
