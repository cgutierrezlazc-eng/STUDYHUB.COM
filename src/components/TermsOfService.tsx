    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal" onClick={e => e.stopPropagation()} style={{ maxWidth: 760, maxHeight: '90vh', overflowY: 'auto' }}>
        ...
        <div style={{ fontSize: 14, lineHeight: 1.85, color: 'var(--text-secondary)' }}>
          ...
          <p>8.1. Los pagos se procesan de forma segura a través de Stripe, Inc. Conniku no almacena, accede ni procesa directamente datos de tarjetas de crédito o débito. Todo procesamiento de pagos cumple con el estándar PCI DSS (Payment Card Industry Data Security Standard).</p>
          ...
          <p>20.1. <strong>La información personal del Usuario es privada y confidencial.</strong> Conniku no comparte, vende, arrienda, cede ni transfiere datos personales a terceros bajo ninguna circunstancia, salvo: (a) cuando medie orden judicial o requerimiento de autoridad competente; (b) cuando sea estrictamente necesario para el procesamiento de pagos a través de Stripe; (c) cuando el Usuario otorgue consentimiento expreso e informado.</p>
          ...
          <p>26.1. La Plataforma puede contener enlaces a sitios web, aplicaciones o servicios operados por terceros (incluyendo Stripe, Zoom, Google y otros). Conniku no controla, respalda ni asume responsabilidad por el contenido, políticas de privacidad ni prácticas de dichos terceros.</p>
