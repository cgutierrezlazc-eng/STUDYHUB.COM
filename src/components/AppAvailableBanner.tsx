...
export default function AppAvailableBanner() {
  ...
  const GooglePlayIcon = () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
      <path d="M3.61 1.814L13.793 12 3.61 22.186a1.004 1.004 0 0 1-.61-.92V2.734c0-.384.22-.72.61-.92z" fill="#4285F4"/>
      <path d="M17.287 8.445L5.12.618C4.737.39 4.29.333 3.91.5l10.183 11.5 3.194-3.555z" fill="#34A853"/>
      <path d="M3.91 23.5c.38.167.827.11 1.21-.118l12.167-7.827-3.194-3.555L3.91 23.5z" fill="#EA4335"/>
      <path d="M21.177 10.655l-3.89-2.21-3.494 3.555 3.494 3.555 3.89-2.21c.72-.41.72-1.28 0-1.69z" fill="#FBBC05"/>
    </svg>
  )

  const AppStoreIcon = () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
      <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z" fill="#0D84FF"/>
    </svg>
  )
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          {isIPhone && (
            <div style={{
              ...
              {Smartphone({ size: 18 })}
              <div>
                <div style={{ fontWeight: 600, color: 'var(--text-primary)' }}>Instalar en iPhone</div>
          ...
          {isIPad && (
            <div style={{
              ...
              {Tablet({ size: 18 })}
              <div>
                <div style={{ fontWeight: 600, color: 'var(--text-primary)' }}>Instalar en iPad</div>
                <div style={{ fontSize: 11, color: 'var(--text-muted)', marginTop: 2 }}>
                  En tu iPad, toca el boton de compartir <span style={{ fontSize: 15 }}>&#x2191;</span> en Safari y selecciona "Agregar a pantalla de inicio"
                </div>
              </div>
            </div>
          )}
          ...
          <p style={{
            ...
            Estamos trabajando para llegar a Google Play y App Store muy pronto. Mientras tanto, instala la version web que funciona igual de bien.
          </p>
