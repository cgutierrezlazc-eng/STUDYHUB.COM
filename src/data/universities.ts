...
const MX_UNIVERSITIES: University[] = [
  {
    ...
    newsUrl: 'https://www.unam.mx/noticias',
  },
  {
    id: 'mx-itesm',
  ...
  {
    id: 'mx-uaemex',
    name: 'Universidad Autonoma del Estado de Mexico',
    shortName: 'UAEMex',
    country: 'MX',
    type: 'universidad',
  ...
  {
    id: 'mx-anahuac',
    name: 'Universidad Anahuac',
    shortName: 'Anahuac',
    country: 'MX',
    type: 'universidad',
    website: 'https://www.anahuac.mx',
  },
  {
    id: 'mx-lasalle',
...
const CO_UNIVERSITIES: University[] = [
  {
    ...
    newsUrl: 'https://agenciadenoticias.unal.edu.co',
  },
  {
    id: 'co-uniandes',
    name: 'Universidad de los Andes',
  ...
  },
  {
    ...
    country: 'CO',
    type: 'universidad',
    website: 'https://www.urosario.edu.co',
  },
  {
    id: 'co-eafit',
  ...
  },
  {
    ...
    country: 'CO',
    type: 'universidad',
    website: 'https://www.icesi.edu.co',
  },
  {
    id: 'co-uis',
  ...
  },
  {
    ...
    country: 'CO',
    type: 'universidad',
    website: 'https://www.uexternado.edu.co',
  },
  {
    id: 'co-bolivariana',
  ...
  },
  {
    ...
    country: 'CO',
    type: 'universidad',
    website: 'https://www.utadeo.edu.co',
  },
  {
    id: 'co-ean',
    ...
    country: 'CO',
    type: 'universidad',
    website: 'https://www.universidadean.edu.co',
  },
  {
    id: 'co-utp',
...
const AR_UNIVERSITIES: University[] = [
  {
    ...
    newsUrl: 'https://www.uba.ar/noticia/',
  },
  {
    id: 'ar-itba',
  ...
  {
    id: 'ar-uca',
    name: 'Pontificia Universidad Catolica Argentina',
    shortName: 'UCA',
    country: 'AR',
    type: 'universidad',
...
const BR_UNIVERSITIES: University[] = [
  ...
  {
    id: 'br-pucsp',
    name: 'Pontificia Universidade Catolica de Sao Paulo',
    shortName: 'PUC-SP',
    country: 'BR',
    type: 'universidad',
  ...
  {
    id: 'br-ita',
    name: 'Instituto Tecnologico de Aeronautica',
    shortName: 'ITA',
    country: 'BR',
    type: 'universidad',
...
const EC_UNIVERSITIES: University[] = [
  ...
  {
    id: 'ec-puce',
    name: 'Pontificia Universidad Catolica del Ecuador',
    shortName: 'PUCE',
    country: 'EC',
    type: 'universidad',
  ...
  },
  {
    ...
    country: 'EC',
    type: 'universidad',
    website: 'https://www.uazuay.edu.ec',
  },
  {
    id: 'ec-utpl',
  ...
  {
    id: 'ec-uees',
    name: 'Universidad de Especialidades Espiritu Santo',
    shortName: 'UEES',
    country: 'EC',
    type: 'universidad',
  ...
  },
  {
    ...
    country: 'EC',
    type: 'universidad',
    website: 'https://www.uisek.edu.ec',
  },
  {
    id: 'ec-ute',
    name: 'Universidad Tecnologica Equinoccial',
    shortName: 'UTE',
    country: 'EC',
    type: 'universidad',
  ...
  {
    id: 'ec-utn',
    name: 'Universidad Tecnica del Norte',
    shortName: 'UTN',
    country: 'EC',
    type: 'universidad',
  ...
  {
    id: 'ec-ucsg',
    name: 'Universidad Catolica de Santiago de Guayaquil',
    shortName: 'UCSG',
    country: 'EC',
    type: 'universidad',
  ...
  },
  {
    ...
    country: 'EC',
    type: 'universidad',
    website: 'https://www.upacifico.edu.ec',
  },
  {
    id: 'ec-uhemisferios',
    name: 'Universidad de Los Hemisferios',
    shortName: 'UHemisf',
    country: 'EC',
    type: 'universidad',
    website: 'https://www.uhemisferios.edu.ec',
  },
];
...
const UY_UNIVERSITIES: University[] = [
  ...
  {
    id: 'uy-ucudal',
    name: 'Universidad Catolica del Uruguay',
    shortName: 'UCU',
    country: 'UY',
    type: 'universidad',
  ...
  {
    id: 'uy-utec',
    name: 'Universidad Tecnologica del Uruguay',
    shortName: 'UTEC',
    country: 'UY',
    type: 'universidad',
    website: 'https://www.utec.edu.uy',
  },
  {
    id: 'uy-claeh',
    ...
    country: 'UY',
    type: 'universidad',
    website: 'https://universidad.claeh.edu.uy',
  },
  {
    id: 'uy-ude',
  ...
  {
    id: 'uy-ucu',
    name: 'Universidad UCUDAL Damaso Antonio Larranaga',
    shortName: 'UCUDAL',
    country: 'UY',
    type: 'universidad',
    website: 'https://www.ucu.edu.uy',
  ...
  {
    id: 'uy-unilasalle',
    name: 'Universidad de la Salle Uruguay',
    shortName: 'La Salle UY',
    country: 'UY',
    type: 'universidad',
    website: 'https://www.lasalle.edu.uy',
  },
  {
    id: 'uy-upunta',
    name: 'Universidad de Punta del Este',
    shortName: 'UPE',
    country: 'UY',
    type: 'universidad',
    website: 'https://www.upe.edu.uy',
  },
  {
    id: 'uy-utu',
    name: 'Universidad del Trabajo del Uruguay',
    shortName: 'UTU',
    country: 'UY',
    type: 'instituto',
  ...
  {
    id: 'uy-anep',
    name: 'Administracion Nacional de Educacion Publica',
    shortName: 'ANEP',
    country: 'UY',
    type: 'instituto',
    website: 'https://www.anep.edu.uy',
  },
  {
    id: 'uy-isede',
    name: 'Instituto Superior de Educacion',
    shortName: 'ISEDE',
    country: 'UY',
    type: 'instituto',
    website: 'https://www.isede.edu.uy',
  },
  {
    id: 'uy-bios',
    name: 'Instituto BIOS',
  ...
  {
    id: 'uy-cure',
    name: 'Centro Universitario Regional del Este',
    shortName: 'CURE',
    country: 'UY',
    type: 'universidad',
    website: 'https://www.cure.edu.uy',
  },
  {
    id: 'uy-uclaeh',
    name: 'Centro Latinoamericano de Economia Humana',
    shortName: 'CLAEH',
    country: 'UY',
    type: 'universidad',
    website: 'https://www.claeh.edu.uy',
  },
  {
    id: 'uy-iuacj',
    ...
    country: 'UY',
    type: 'instituto',
    website: 'https://www.iuacj.edu.uy',
  },
  {
    id: 'uy-iecon',
    ...
    country: 'UY',
    type: 'instituto',
    website: 'https://www.iecon.ccee.edu.uy',
  },
  {
    id: 'uy-cediiap',
    name: 'Centro de Investigacion y Docencia',
    shortName: 'CEDIIAP',
    country: 'UY',
    type: 'instituto',
    website: 'https://www.cediiap.edu.uy',
  },
];
...
const PY_UNIVERSITIES: University[] = [
  {
    id: 'py-una',
    name: 'Universidad Nacional de Asuncion',
    shortName: 'UNA',
    country: 'PY',
    type: 'universidad',
  ...
  {
    id: 'py-uca',
    name: 'Universidad Catolica Nuestra Senora de la Asuncion',
    shortName: 'UCA',
    country: 'PY',
    type: 'universidad',
  ...
  {
    id: 'py-uaa',
    name: 'Universidad Autonoma de Asuncion',
    shortName: 'UAA',
    country: 'PY',
    type: 'universidad',
  ...
  {
    id: 'py-uca-itapua',
    name: 'Universidad Catolica de Itapua',
    shortName: 'UCI',
    country: 'PY',
    type: 'universidad',
    website: 'https://www.ucitapua.edu.py',
  },
  {
    id: 'py-une',
  ...
  {
    id: 'py-unican',
    name: 'Universidad Nacional de Canindeyu',
    shortName: 'UNICAN',
    country: 'PY',
    type: 'universidad',
    website: 'https://www.unican.edu.py',
  },
  {
    id: 'py-utic',
    name: 'Universidad Tecnologica Intercontinental',
    shortName: 'UTIC',
    country: 'PY',
    type: 'universidad',
    website: 'https://www.utic.edu.py',
  },
  {
    id: 'py-unp',
  ...
  {
    id: 'py-upap',
    name: 'Universidad Politecnica y Artistica del Paraguay',
    shortName: 'UPAP',
    country: 'PY',
    type: 'universidad',
    website: 'https://www.upap.edu.py',
  },
  {
    id: 'py-unida',
    name: 'Universidad de la Integracion de las Americas',
    shortName: 'UNIDA',
    country: 'PY',
    type: 'universidad',
    website: 'https://www.unida.edu.py',
  },
  {
    id: 'py-ucsa',
    name: 'Universidad del Cono Sur de las Americas',
    shortName: 'UCSA',
    country: 'PY',
    type: 'universidad',
    website: 'https://www.ucsa.edu.py',
  },
  {
    id: 'py-umi',
    name: 'Universidad Maria Auxiliadora',
    shortName: 'UNIMAS',
    country: 'PY',
    type: 'universidad',
    website: 'https://www.unimas.edu.py',
  },
  {
    id: 'py-ibero',
    name: 'Universidad Iberoamericana',
    ...
    country: 'PY',
    type: 'universidad',
    website: 'https://www.unibe.edu.py',
  },
  {
    id: 'py-ung',
    ...
    country: 'PY',
    type: 'universidad',
    website: 'https://www.ung.edu.py',
  },
  {
    id: 'py-uninternacional',
    name: 'Universidad Internacional Tres Fronteras',
    shortName: 'UNITF',
    country: 'PY',
    type: 'universidad',
    website: 'https://www.unitresfronteras.edu.py',
  },
  {
    id: 'py-ucnsa',
...
const BO_UNIVERSITIES: University[] = [
  ...
  {
    id: 'bo-usfx',
    name: 'Universidad Mayor Real y Pontificia de San Francisco Xavier de Chuquisaca',
    shortName: 'USFX',
    country: 'BO',
    type: 'universidad',
  ...
  {
    id: 'bo-emi',
    name: 'Escuela Militar de Ingenieria',
    shortName: 'EMI',
    country: 'BO',
    type: 'universidad',
    website: 'https://www.emi.edu.bo',
  },
  {
    id: 'bo-unitepc',
    ...
    country: 'BO',
    type: 'universidad',
    website: 'https://www.unitepc.edu.bo',
  },
  {
    id: 'bo-ucebol',
    name: 'Universidad Cristiana de Bolivia',
    shortName: 'UCEBOL',
    country: 'BO',
    type: 'universidad',
    website: 'https://www.ucebol.edu.bo',
  },
  {
    id: 'bo-utb',
    name: 'Universidad Tecnica de Beni',
    shortName: 'UTB',
    country: 'BO',
    type: 'universidad',
    website: 'https://www.utb.edu.bo',
  },
  {
    id: 'bo-uap',
  ...
  },
  {
    ...
    country: 'BO',
    type: 'universidad',
    website: 'https://www.unifranz.edu.bo',
  },
  {
    id: 'bo-nur',
  ...
  },
  {
    ...
    country: 'BO',
    type: 'universidad',
    website: 'https://www.ureal.edu.bo',
  },
];
...
const VE_UNIVERSITIES: University[] = [
  ...
  },
  {
    ...
    country: 'VE',
    type: 'universidad',
    website: 'https://www.uc.edu.ve',
  },
  {
    id: 've-uniandes',
    name: 'Universidad Privada Dr. Rafael Belloso Chacin',
    shortName: 'URBE',
    country: 'VE',
    type: 'universidad',
    website: 'https://www.urbe.edu',
  },
  {
    id: 've-unexpo',
    ...
    country: 'VE',
    type: 'universidad',
    website: 'https://www.unexpo.edu.ve',
  },
  {
    id: 've-ucla',
  ...
  },
  {
    ...
    country: 'VE',
    type: 'universidad',
    website: 'https://www.ujap.edu.ve',
  },
  {
    id: 've-uat',
    name: 'Universidad Arturo Michelena',
    shortName: 'UAM',
    country: 'VE',
    type: 'universidad',
    website: 'https://www.uam.edu.ve',
  },
  {
    id: 've-unefa',
    ...
    country: 'VE',
    type: 'universidad',
    website: 'https://www.unefa.edu.ve',
  },
  {
    id: 've-upel',
    name: 'Universidad Pedagogica Experimental Libertador',
    shortName: 'UPEL',
    country: 'VE',
    type: 'universidad',
    website: 'https://www.upel.edu.ve',
  },
  {
    id: 've-unesr',
    ...
    country: 'VE',
    type: 'universidad',
    website: 'https://www.unesr.edu.ve',
  },
  {
    id: 've-uba',
    ...
    country: 'VE',
    type: 'universidad',
    website: 'https://www.uba.edu.ve',
  },
  {
    id: 've-ujmv',
    name: 'Universidad Jose Maria Vargas',
    shortName: 'UJMV',
    country: 'VE',
    type: 'universidad',
    website: 'https://www.ujmv.edu.ve',
  },
];
...
const CR_UNIVERSITIES: University[] = [
  ...
  {
    id: 'cr-utn',
    name: 'Universidad Tecnica Nacional',
    shortName: 'UTN',
    country: 'CR',
    type: 'universidad',
  ...
  {
    id: 'cr-ulacit',
    name: 'Universidad Latinoamericana de Ciencia y Tecnologia',
    shortName: 'ULACIT',
    country: 'CR',
    type: 'universidad',
  ...
  },
  {
    ...
    country: 'CR',
    type: 'universidad',
    website: 'https://www.uam.ac.cr',
  },
  {
    id: 'cr-ucimed',
    name: 'Universidad de Ciencias Medicas',
    shortName: 'UCIMED',
    country: 'CR',
    type: 'universidad',
  ...
  },
  {
    ...
    country: 'CR',
    type: 'universidad',
    website: 'https://www.uspsantapaula.com',
  },
  {
    id: 'cr-uia',
    name: 'Universidad Internacional de las Americas',
    shortName: 'UIA',
    country: 'CR',
    type: 'universidad',
    website: 'https://www.uia.ac.cr',
  },
  {
    id: 'cr-uaca',
    name: 'Universidad Autonoma de Centro America',
    shortName: 'UACA',
    country: 'CR',
    type: 'universidad',
    website: 'https://www.uaca.ac.cr',
  },
  {
    id: 'cr-lead',
  ...
  },
  {
    ...
    country: 'CR',
    type: 'universidad',
    website: 'https://www.uhispanoamericana.ac.cr',
  },
  {
    id: 'cr-earth',
  ...
  },
  {
    ...
    country: 'CR',
    type: 'universidad',
    website: 'https://www.ucenfotec.ac.cr',
  },
  {
    id: 'cr-unadeca',
    name: 'Universidad Adventista de Centroamerica',
    shortName: 'UNADECA',
    country: 'CR',
    type: 'universidad',
    website: 'https://www.unadeca.ac.cr',
  },
];
...
const PA_UNIVERSITIES: University[] = [
  ...
  },
  {
    ...
    country: 'PA',
    type: 'universidad',
    website: 'https://www.utp.ac.pa',
  },
  {
    id: 'pa-usma',
    name: 'Universidad Catolica Santa Maria La Antigua',
    shortName: 'USMA',
    country: 'PA',
    type: 'universidad',
  ...
  {
    id: 'pa-ulat',
    name: 'Universidad Latina de Panama',
    shortName: 'ULAT',
    country: 'PA',
    type: 'universidad',
    website: 'https://www.ulat.ac.pa',
  },
  {
    id: 'pa-fsu-panama',
    name: 'Florida State University Panama',
    shortName: 'FSU Panama',
    country: 'PA',
    type: 'university',
  ...
  {
    id: 'pa-umip',
    name: 'Universidad Maritima Internacional de Panama',
    shortName: 'UMIP',
    country: 'PA',
    type: 'universidad',
    website: 'https://www.umip.ac.pa',
  },
  {
    id: 'pa-aden',
    name: 'ADEN University',
    shortName: 'ADEN',
    country: 'PA',
    type: 'university',
    website: 'https://www.adenuniversity.edu.pa',
  },
  {
    id: 'pa-quality',
    name: 'Quality Leadership University',
    shortName: 'QLU',
    country: 'PA',
    type: 'university',
    website: 'https://www.qlu.ac.pa',
  },
  {
    id: 'pa-columbus',
    ...
    country: 'PA',
    type: 'university',
    website: 'https://www.columbus.edu',
  },
  {
    id: 'pa-isae',
    name: 'ISAE Universidad',
    shortName: 'ISAE',
    country: 'PA',
    type: 'universidad',
    website: 'https://www.isaeuniversidad.ac.pa',
  },
  {
    id: 'pa-uam',
    name: 'Universidad del Arte Ganexa',
    shortName: 'Ganexa',
    country: 'PA',
    type: 'universidad',
    website: 'https://www.ganexa.edu.pa',
  },
  {
    id: 'pa-unadp',
    ...
    country: 'PA',
    type: 'universidad',
    website: 'https://www.unadp.ac.pa',
  },
  {
    id: 'pa-uniedpa',
    name: 'Universidad OTEIMA',
    shortName: 'OTEIMA',
    country: 'PA',
    type: 'universidad',
    website: 'https://www.oteima.ac.pa',
  },
  {
    id: 'pa-udi',
    ...
    country: 'PA',
    type: 'universidad',
    website: 'https://www.udi.edu',
  },
  {
    id: 'pa-louisville',
    name: 'University of Louisville Panama',
    shortName: 'UofL Panama',
    country: 'PA',
    type: 'university',
  ...
  {
    id: 'pa-americana',
    name: 'Universidad Americana de Panama',
    shortName: 'UAM',
    country: 'PA',
    type: 'universidad',
    website: 'https://www.uam.edu.pa',
  },
  {
    id: 'pa-metropolitana',
    name: 'Universidad Metropolitana de Educacion',
    shortName: 'UMECIT',
    country: 'PA',
    type: 'universidad',
...
const DO_UNIVERSITIES: University[] = [
  ...
  {
    id: 'do-unphu',
    name: 'Universidad Nacional Pedro Henriquez Urena',
    shortName: 'UNPHU',
    country: 'DO',
    type: 'universidad',
  ...
  {
    id: 'do-ucsd',
    name: 'Universidad Catolica de Santo Domingo',
    shortName: 'UCSD',
    country: 'DO',
    type: 'universidad',
  ...
  {
    id: 'do-ufhec',
    name: 'Universidad Federico Henriquez y Carvajal',
    shortName: 'UFHEC',
    country: 'DO',
    type: 'universidad',
  ...
  {
    id: 'do-unev',
    name: 'Universidad Nacional Evangelica',
    shortName: 'UNEV',
    country: 'DO',
    type: 'universidad',
  ...
  {
    id: 'do-uafam',
    name: 'Universidad Agroforestal Fernando Arturo de Merino',
    shortName: 'UAFAM',
    country: 'DO',
    type: 'universidad',
    website: 'https://www.uafam.edu.do',
  },
  {
    id: 'do-ucne',
  ...
  {
    id: 'do-unnatec',
    name: 'Universidad Nacional Tecnologica',
    shortName: 'UNNATEC',
    country: 'DO',
    type: 'universidad',
    website: 'https://www.unnatec.edu.do',
  },
  {
    id: 'do-oym',
  ...
  {
    id: 'do-pucamaima',
    name: 'Universidad Catolica del Cibao',
    shortName: 'UCATECI',
    country: 'DO',
    type: 'universidad',
...
const GT_UNIVERSITIES: University[] = [
  ...
  {
    id: 'gt-url',
    name: 'Universidad Rafael Landivar',
    shortName: 'URL',
    country: 'GT',
    type: 'universidad',
    website: 'https://www.url.edu.gt',
  },
  {
    id: 'gt-uvg',
  ...
  },
  {
    ...
    country: 'GT',
    type: 'universidad',
    website: 'https://www.urural.edu.gt',
  },
  {
    id: 'gt-uinteramericana',
    name: 'Universidad InterNaciones',
    shortName: 'UNI',
    country: 'GT',
    type: 'universidad',
    website: 'https://www.uni.edu.gt',
  },
  {
    id: 'gt-uda',
    ...
    country: 'GT',
    type: 'universidad',
    website: 'https://www.udv.edu.gt',
  },
  {
    id: 'gt-cunoc',
    name: 'Centro Universitario de Occidente USAC',
    shortName: 'CUNOC',
    country: 'GT',
    type: 'universidad',
    website: 'https://www.cunoc.usac.edu.gt',
  },
  {
    id: 'gt-usantapaula',
    ...
    country: 'GT',
    type: 'universidad',
    website: 'https://www.uspg.edu.gt',
  },
  {
    id: 'gt-ucv',
    name: 'Universidad de Ciencias Comerciales',
    shortName: 'UCC',
    country: 'GT',
    type: 'universidad',
    website: 'https://www.ucc.edu.gt',
  },
  {
    id: 'gt-ectafide',
    name: 'Escuela de Ciencia y Tecnologia ECTAFIDE',
    shortName: 'ECTAFIDE',
    country: 'GT',
    type: 'instituto',
    website: 'https://www.ectafide.edu.gt',
  },
  {
    id: 'gt-intecap',
    name: 'Instituto Tecnico de Capacitacion y Productividad',
    shortName: 'INTECAP',
    country: 'GT',
    type: 'instituto',
    website: 'https://www.intecap.edu.gt',
  },
  {
    id: 'gt-usa',
    ...
    country: 'GT',
    type: 'universidad',
    website: 'https://www.usap.edu.gt',
  },
  {
    id: 'gt-ucaribeana',
    name: 'Universidad Caribena de Guatemala',
    shortName: 'UCG',
    country: 'GT',
    type: 'universidad',
    website: 'https://www.ucg.edu.gt',
  },
  {
    id: 'gt-unp',
    name: 'Universidad de la Paz',
    shortName: 'UPAZ',
    country: 'GT',
    type: 'universidad',
    website: 'https://www.upaz.edu.gt',
  },
];
...
const HN_UNIVERSITIES: University[] = [
  ...
  {
    id: 'hn-upnfm',
    name: 'Universidad Pedagogica Nacional Francisco Morazan',
    shortName: 'UPNFM',
    country: 'HN',
    type: 'universidad',
  ...
  {
    id: 'hn-zamorano',
    name: 'Escuela Agricola Panamericana El Zamorano',
    shortName: 'Zamorano',
    country: 'HN',
    type: 'universidad',
  ...
  {
    id: 'hn-upi',
    name: 'Universidad Politecnica de Ingenieria',
    shortName: 'UPI',
    country: 'HN',
    type: 'universidad',
  ...
  {
    id: 'hn-ucenm',
    name: 'Universidad Cristiana Evangelica Nuevo Milenio',
    shortName: 'UCENM',
    country: 'HN',
    type: 'universidad',
    website: 'https://www.ucenm.edu.hn',
  },
  {
    id: 'hn-unicah',
  ...
  {
    id: 'hn-utm',
    name: 'Universidad Tecnologica de Honduras',
    shortName: 'UTH',
    country: 'HN',
    type: 'universidad',
  ...
  },
  {
    ...
    country: 'HN',
    type: 'universidad',
    website: 'https://www.unag.edu.hn',
  },
  {
    id: 'hn-udn',
    name: 'Universidad de Defensa Nacional',
    shortName: 'UDN',
    country: 'HN',
    type: 'universidad',
    website: 'https://www.udn.edu.hn',
  },
  {
    id: 'hn-ujcv',
    name: 'Universidad Jose Cecilio del Valle',
    shortName: 'UJCV',
    country: 'HN',
    type: 'universidad',
  ...
  {
    id: 'hn-ceutec',
    name: 'CEUTEC Honduras',
    shortName: 'CEUTEC',
    country: 'HN',
    type: 'universidad',
    website: 'https://www.ceutec.edu.hn',
  },
  {
    id: 'hn-unm',
    name: 'Universidad Nacional de la Marina Mercante',
    shortName: 'UNM',
    country: 'HN',
    type: 'universidad',
    website: 'https://www.unm.edu.hn',
  },
  {
    id: 'hn-usap',
    name: 'Universidad de San Pedro y San Pablo',
    shortName: 'USP',
    country: 'HN',
    type: 'universidad',
    website: 'https://www.usp.edu.hn',
  },
  {
    id: 'hn-uah',
    ...
    country: 'HN',
    type: 'universidad',
    website: 'https://www.umh.edu.hn',
  },
  {
    id: 'hn-infop',
    name: 'Instituto Nacional de Formacion Profesional',
    shortName: 'INFOP',
    country: 'HN',
    type: 'instituto',
    website: 'https://www.infop.hn',
  },
  {
    id: 'hn-unah-vs',
    name: 'UNAH Valle de Sula',
    shortName: 'UNAH-VS',
    country: 'HN',
    type: 'universidad',
    website: 'https://www.unah.edu.hn',
  ...
  {
    id: 'hn-curla',
    name: 'Centro Universitario Regional del Litoral Atlantico',
    shortName: 'CURLA',
    country: 'HN',
    type: 'universidad',
    website: 'https://www.unah.edu.hn',
...
const SV_UNIVERSITIES: University[] = [
  ...
  {
    id: 'sv-uca',
    name: 'Universidad Centroamericana Jose Simeon Canas',
    shortName: 'UCA',
    country: 'SV',
    type: 'universidad',
  ...
  {
    id: 'sv-utec',
    name: 'Universidad Tecnologica de El Salvador',
    shortName: 'UTEC',
    country: 'SV',
    type: 'universidad',
  ...
  {
    id: 'sv-monica',
    name: 'Universidad Monica Herrera',
    shortName: 'UMH',
    country: 'SV',
    type: 'universidad',
    website: 'https://www.monicaherrera.edu.sv',
  },
  {
    id: 'sv-univo',
    name: 'Universidad de Oriente',
  ...
  {
    id: 'sv-uped',
    name: 'Universidad Pedagogica de El Salvador',
    shortName: 'UPES',
    country: 'SV',
    type: 'universidad',
  ...
  {
    id: 'sv-up',
    name: 'Universidad Panamericana de El Salvador',
    shortName: 'UPAN',
    country: 'SV',
    type: 'universidad',
    website: 'https://www.upan.edu.sv',
  },
  {
    id: 'sv-usonsonate',
    ...
    country: 'SV',
    type: 'universidad',
    website: 'https://www.usonsonate.edu.sv',
  },
  {
    id: 'sv-andres',
    name: 'Universidad Andres Bello El Salvador',
    shortName: 'UNAB SV',
    country: 'SV',
    type: 'universidad',
    website: 'https://www.unab.edu.sv',
  },
  {
    id: 'sv-ean',
    name: 'Escuela de Artes y Negocios',
    shortName: 'EAN',
    country: 'SV',
    type: 'instituto',
    website: 'https://www.ean.edu.sv',
  },
  {
    id: 'sv-itca',
  ...
  {
    id: 'sv-ucm',
    name: 'Universidad Capitan General Gerardo Barrios',
    shortName: 'UGB',
    country: 'SV',
    type: 'universidad',
  ...
  },
  {
    ...
    country: 'SV',
    type: 'universidad',
    website: 'https://www.ulpaz.edu.sv',
  },
];
...
const NI_UNIVERSITIES: University[] = [
  ...
  {
    id: 'ni-unan-leon',
    name: 'Universidad Nacional Autonoma de Nicaragua Leon',
    shortName: 'UNAN-Leon',
    country: 'NI',
    type: 'universidad',
  ...
  },
  {
    ...
    country: 'NI',
    type: 'universidad',
    website: 'https://www.upoli.edu.ni',
  },
  {
    id: 'ni-uam',
    name: 'Universidad Americana',
  ...
  {
    id: 'ni-unica',
    name: 'Universidad de las Regiones Autonomas de la Costa Caribe Nicaraguense',
    shortName: 'URACCAN',
    country: 'NI',
    type: 'universidad',
  ...
  },
  {
    ...
    country: 'NI',
    type: 'universidad',
    website: 'https://www.uhispam.edu.ni',
  },
  {
    id: 'ni-bicu',
    name: 'Bluefields Indian and Caribbean University',
    shortName: 'BICU',
    country: 'NI',
    type: 'university',
  ...
  {
    id: 'ni-uth',
    name: 'Universidad Thomas More',
    shortName: 'UTM',
    country: 'NI',
    type: 'universidad',
    website: 'https://www.utm.edu.ni',
  },
  {
    id: 'ni-uniav',
    name: 'Universidad Internacional para el Desarrollo',
    shortName: 'UNID',
    country: 'NI',
    type: 'universidad',
    website: 'https://www.unid.edu.ni',
  },
  {
    id: 'ni-ulam',
    name: 'Universidad Latinoamericana de Managua',
    shortName: 'ULAM',
    country: 'NI',
    type: 'universidad',
    website: 'https://www.ulam.edu.ni',
  },
  {
    id: 'ni-ucyt',
    name: 'Universidad de Ciencias y Tecnologia',
    shortName: 'UCyT',
    country: 'NI',
    type: 'universidad',
    website: 'https://www.ucyt.edu.ni',
  },
  {
    id: 'ni-keiser',
    name: 'Keiser University Nicaragua',
    shortName: 'Keiser',
    country: 'NI',
    type: 'university',
    website: 'https://www.keiseruniversity.edu.ni',
  },
  {
    id: 'ni-unicit',
    ...
    country: 'NI',
    type: 'universidad',
    website: 'https://www.unicit.edu.ni',
  },
  {
    id: 'ni-uenic',
    name: 'Universidad Evangelica Nicaraguense',
    shortName: 'UENIC',
    country: 'NI',
    type: 'universidad',
    website: 'https://www.uenic.edu.ni',
  },
  {
    id: 'ni-ucm',
    ...
    country: 'NI',
    type: 'universidad',
    website: 'https://www.ucad.edu.ni',
  },
  {
    id: 'ni-inatec',
    name: 'Instituto Nacional Tecnologico',
    shortName: 'INATEC',
    country: 'NI',
    type: 'instituto',
    website: 'https://www.inatec.edu.ni',
  },
];
...
const US_UNIVERSITIES: University[] = [
  ...
  },
  {
    ...
    newsUrl: 'https://news.stanford.edu',
  },
  {
    id: 'us-harvard',
    ...
    newsUrl: 'https://news.harvard.edu',
  },
  {
    id: 'us-caltech',
...
const ES_UNIVERSITIES: University[] = [
  ...
  {
    id: 'es-ehu',
    name: 'Universidad del Pais Vasco',
    shortName: 'UPV/EHU',
    country: 'ES',
    type: 'universidad',
...
const DE_UNIVERSITIES: University[] = [
  ...
  {
    id: 'de-kit',
    name: 'Karlsruher Institut fur Technologie',
    shortName: 'KIT',
    country: 'DE',
    type: 'university',
  ...
  {
    id: 'de-freiburg',
    name: 'Albert-Ludwigs-Universitat Freiburg',
    shortName: 'Freiburg',
    country: 'DE',
    type: 'university',
  ...
  {
    id: 'de-gottingen',
    name: 'Georg-August-Universitat Gottingen',
    shortName: 'Gottingen',
    country: 'DE',
    type: 'university',
  ...
  {
    id: 'de-bonn',
    name: 'Rheinische Friedrich-Wilhelms-Universitat Bonn',
    shortName: 'Bonn',
    country: 'DE',
    type: 'university',
  ...
  {
    id: 'de-munster',
    name: 'Westfalische Wilhelms-Universitat Munster',
    shortName: 'WWU',
    country: 'DE',
    type: 'university',
  ...
  {
    id: 'de-frankfurt',
    name: 'Goethe-Universitat Frankfurt',
    shortName: 'GU Frankfurt',
    country: 'DE',
    type: 'university',
...
const FR_UNIVERSITIES: University[] = [
  ...
  {
    id: 'fr-ens',
    name: 'Ecole Normale Superieure Paris',
    shortName: 'ENS',
    country: 'FR',
    type: 'university',
...
const IT_UNIVERSITIES: University[] = [
  ...
  {
    id: 'it-sapienza',
    name: 'Sapienza Universita di Roma',
    shortName: 'Sapienza',
    country: 'IT',
    type: 'university',
  ...
  {
    id: 'it-napoli',
    name: 'Universita degli Studi di Napoli Federico II',
    shortName: 'UniNA',
    country: 'IT',
    type: 'university',
  ...
  {
    id: 'it-torino',
    name: 'Universita degli Studi di Torino',
    shortName: 'UniTO',
    country: 'IT',
    type: 'university',
  ...
  {
    id: 'it-roma-tor-vergata',
    name: 'Universita di Roma Tor Vergata',
...
const PT_UNIVERSITIES: University[] = [
  ...
  {
    id: 'pt-ulusitana',
    name: 'Universidade Lusitana',
    shortName: 'Lusitana',
    country: 'PT',
    type: 'university',
    website: 'https://www.lis.ulusiada.pt',
  },
  {
    id: 'pt-iseg',
    name: 'ISEG - Lisbon School of Economics and Management',
    shortName: 'ISEG',
    country: 'PT',
    type: 'university',
