    ...
    <div style={styles.container}>
      ...
      <div style={styles.infoBox}>
        ...
        <ul style={{ ...styles.ul, marginBottom: 0, marginTop: 8 }}>
          ...
          <li>
            <strong>California, EE.UU.:</strong> California Consumer Privacy Act (CCPA) · California
      ...
      <ul style={styles.ul}>
        ...
        <li>
          <strong>Datos de comunicación:</strong> mensajes enviados a través de la plataforma (entre
          usuarios y al soporte).
        </li>
      </ul>
      ...
      <ul style={styles.ul}>
        ...
        <li>
          ...
          académicas, carrera e intereses.
        </li>
        <li>
          <strong>Gamificación:</strong> gestionar el sistema de puntos, logros, rachas de estudio y
          clasificaciones.
        </li>
        <li>
        ...
        <li>
          <strong>Comunicaciones:</strong> responder consultas de soporte y enviar información sobre
          cambios en el servicio.
        </li>
        <li>
          <strong>Seguridad:</strong> prevenir fraude, uso indebido y garantizar la seguridad de la
          plataforma.
        </li>
      </ul>
      ...
      <ul style={styles.ul}>
        <li>
          <strong>Consentimiento del titular (Art. 4°):</strong> al crear una cuenta y aceptar esta
          política, usted consiente expresamente el tratamiento de sus datos.
        </li>
        <li>
          <strong>Ejecución de contrato:</strong> el tratamiento es necesario para la prestación del
          servicio contratado.
        </li>
        <li>
      ...
      <ul style={styles.ul}>
        <li>
          <strong>Consentimiento [Art. 6(1)(a)]:</strong> para comunicaciones de marketing y cookies
          no esenciales.
        </li>
        <li>
      ...
      <ul style={styles.ul}>
        ...
        <li>
          <strong>Interés legítimo [Art. 7°, IX]:</strong> para finalidades legítimas, consideradas
          las expectativas del titular.
        </li>
      </ul>
      ...
      <p style={styles.p}>
        Los datos identificables se eliminan dentro de los <strong>30 días</strong> siguientes a la
        solicitud. Ciertos datos anonimizados pueden conservarse hasta 2 años con fines
      ...
      <ul style={styles.ul}>
        ...
        <li>
          ...
          adicionales cuando sea requerido por ley (registros de facturación, normativa tributaria).
        </li>
      </ul>
      ...
      <div style={styles.jurisdictionBox}>
        ...
        <ul style={styles.ul}>
          ...
          <li>
            <strong>Supresión / "derecho al olvido" [Art. 17]:</strong> solicitar la eliminación de
            sus datos cuando ya no sean necesarios para la finalidad original, revoque su
          ...
          <li>
            <strong>Oposición [Art. 21]:</strong> oponerse al tratamiento basado en interés legítimo
            o para fines de marketing directo.
          </li>
          <li>
      ...
      <div style={styles.jurisdictionBox}>
        ...
        <ul style={styles.ul}>
          ...
          <li>
            <strong>Portabilidade [Art. 18, V]:</strong> portabilidad de sus datos a otro proveedor,
            conforme a regulación de la ANPD.
          </li>
          <li>
          ...
          <li>
            <strong>Revogação do consentimento [Art. 18, IX]:</strong> revocar el consentimiento en
            cualquier momento, sin perjuicio del tratamiento previo.
          </li>
          <li>
      ...
      <div style={styles.jurisdictionBox}>
        ...
        <ul style={styles.ul}>
          <li>
            <strong>Right to Know [§1798.100]:</strong> derecho a saber qué categorías e información
            personal específica hemos recopilado, sus fuentes, finalidades y terceros con quienes se
            comparte.
          </li>
          <li>
          ...
          <li>
            <strong>Right to Non-Discrimination [§1798.125]:</strong> Conniku no discriminará a los
            usuarios que ejerzan sus derechos CCPA. No se le denegarán servicios, se le cobrarán
            precios diferentes ni se le ofrecerá calidad de servicio inferior por ejercer sus
            derechos.
          </li>
        </ul>
        <p style={{ ...styles.p, marginBottom: 4 }}>
      ...
      <ul style={styles.ul}>
        <li>
          ...
          Contractuales Tipo (Standard Contractual Clauses — SCCs) aprobadas por la Comisión Europea
          (Decisión 2021/914) como salvaguardia adecuada. Puede solicitar una copia de estas
          cláusulas escribiendo a privacidad@conniku.com.
        </li>
        <li>
          <strong>Usuarios de Brasil (LGPD Art. 33):</strong> la transferencia internacional se
          realiza con garantías equivalentes de protección, conforme a los mecanismos aprobados por
          la ANPD.
        </li>
        <li>
