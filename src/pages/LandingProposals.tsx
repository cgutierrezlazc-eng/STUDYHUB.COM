    ...
    >
      ...
      >
        ...
        >
          ...
          >
            PLATAFORMA UNIVERSITARIA — CHILE
          </span>
        </div>
        ...
        >
          La plataforma que
          <br />
          <span style={{ color: '#0066FF' }}>merecías</span> en la
          <br />
          universidad.
        </h1>
        ...
        <div style={{ display: 'flex', gap: 32, alignItems: 'flex-start', flexWrap: 'wrap' }}>
          ...
          >
            Estudia de forma inteligente, conecta con tu carrera y construye tu futuro profesional —
            todo en un mismo lugar, diseñado para estudiantes universitarios chilenos.
          </p>
      ...
      >
        {[
          ...
          ['50+', 'Tutores verificados'],
          ['12', 'Universidades'],
          ['98%', 'Satisfacción'],
        ].map(([n, l], i) => (
          <div
            key={l}
            className="propD-stat"
            style={{
          ...
          {[
            {
              ...
              desc: 'Resumenes generados automaticamente, rutas de estudio personalizadas y quizzes adaptativos que se ajustan a tu nivel.',
            },
            {
              num: '02',
              title: 'Red universitaria real',
              desc: 'Conecta con compañeros de carrera, forma grupos de estudio, accede a comunidades por ramo y encuentra mentores.',
            },
            {
              num: '03',
              title: 'Tutores verificados',
              desc: 'Sesiones 1:1 con tutores calificados de tu propia universidad. Certificados con código de verificación único.',
            },
            {
              num: '04',
              title: 'Bolsa de trabajo exclusiva',
              desc: 'Prácticas y empleos part-time para universitarios. CV integrado, sin necesidad de LinkedIn ni portales externos.',
            },
          ].map((f, i) => (
            <div
              key={f.num}
    ...
    >
      ...
      <section
        style={{
          ...
          maxWidth: 800,
          margin: '0 auto',
          animation: 'fadeInE 0.7s ease both',
        }}
      >
        <div
          style={{
        ...
        >
          La plataforma académica que une aprendizaje inteligente, red social universitaria y
        ...
        >
          <button
            ...
            style={{
              ...
              cursor: 'pointer',
              fontFamily: font,
              boxShadow: '0 1px 3px rgba(37,99,235,0.35), inset 0 1px 0 rgba(255,255,255,0.12)',
            }}
          >
            Comenzar gratis
          </button>
        ...
        <p style={{ fontSize: 11, color: '#94A3B8', letterSpacing: 0.3 }}>
            ...
            >
              ...
              <div style={{ padding: '0 16px' }}>
                ...
                {['Empleos', 'Mi CV', 'Eventos'].map((item) => (
                  ...
                  >
                    <div
                      style={{ width: 3, height: 3, borderRadius: '50%', background: '#CBD5E1' }}
                    />
            ...
            <div style={{ flex: 1, padding: 20, background: '#FAFAFA', overflowY: 'auto' }}>
              <div style={{ marginBottom: 16 }}>
                ...
                <p style={{ fontSize: 12, color: '#94A3B8', margin: 0 }}>
                  Jueves 9 de abril — 3 tareas pendientes
                </p>
              </div>
              <div
                style={{
              ...
              >
                ...
                {[
                  ['Resumen automatico', 'Cálculo II', '#EFF6FF', '#2563EB'],
                  ['Quizz completado', 'Física · 9/10', '#F0FDF4', '#059669'],
                  ['Conexión nueva', 'María J. · UAI', '#F5F3FF', '#7C3AED'],
                ].map(([a, b, bg, c]) => (
                  <div
                    key={a}
                    style={{
      ...
      <section style={{ padding: '0 clamp(20px,5vw,48px) 72px', maxWidth: 940, margin: '0 auto' }}>
        ...
        >
          {[
            {
              label: 'Aprendizaje inteligente',
              desc: 'Resúmenes automáticos, rutas de estudio y quizzes adaptativos para aprender más en menos tiempo.',
              accent: '#2563EB',
            },
            {
              label: 'Red universitaria',
              desc: 'Comunidades por ramo, grupos de estudio, mensajería y conexiones con estudiantes de tu carrera.',
              accent: '#7C3AED',
            },
            {
              label: 'Tutores reales',
              desc: 'Sesiones presenciales u online con tutores de tu universidad. Ratings verificados, certificados únicos.',
              accent: '#0891B2',
            },
            {
              label: 'Empleos exclusivos',
              desc: 'Prácticas y trabajos part-time para universitarios. Tu CV profesional siempre listo.',
              accent: '#059669',
            },
          ].map((f) => (
            <div
              key={f.label}
              className="propE-card"
              style={{
                background: '#fff',
                border: '1px solid #E2E8F0',
                borderRadius: 12,
      ...
      >
        ...
        >
          Únete a los mejores
          <br />
          <span style={{ color: '#60A5FA' }}>estudiantes de Chile.</span>
        </h2>
        <p style={{ fontSize: 14, color: '#94A3B8', marginBottom: 28 }}>
          +1,200 universitarios ya usan Conniku. Sin costo, para siempre.
        </p>
        <button
          onClick={onRegister}
          style={{
  ...
  return (
    ...
    >
      ...
      <section
        style={{
          position: 'relative',
          padding: 'clamp(64px,10vw,96px) clamp(20px,5vw,48px) clamp(48px,6vw,64px)',
          textAlign: 'center',
          overflow: 'hidden',
        }}
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              'linear-gradient(-45deg, rgba(109,40,217,0.25), rgba(37,99,235,0.2), rgba(6,182,212,0.18), rgba(139,92,246,0.22))',
            backgroundSize: '400% 400%',
            animation: 'auroraF 10s ease infinite',
            pointerEvents: 'none',
          }}
        />
        <div
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: 800, margin: '0 auto' }}>
          ...
          >
            ...
            <span
              style={{
                ...
                animation: 'auroraF 6s ease infinite',
              }}
            >
          ...
          >
            Conniku reúne lo mejor del mundo académico y profesional en una sola plataforma,
            diseñada para universitarios chilenos.
          </p>
      ...
      >
        <div
          style={{
            ...
            display: 'flex',
            gap: 56,
            animation: 'tickF 20s linear infinite',
            whiteSpace: 'nowrap',
            height: 48,
            alignItems: 'center',
            paddingLeft: 32,
          ...
          {[
            {
              ...
              sub: 'Resúmenes automáticos, quizzes adaptativos y rutas de aprendizaje personalizadas para cada ramo.',
              accent: 'linear-gradient(135deg, #6D28D9, #8B5CF6)',
              dot: '#A78BFA',
            },
            {
              title: 'Red universitaria',
              sub: 'Comunidades activas, grupos de estudio, mensajería en tiempo real y conexiones con tu carrera.',
              accent: 'linear-gradient(135deg, #1D4ED8, #3B82F6)',
              dot: '#60A5FA',
            },
            {
              title: 'Tutorías verificadas',
              sub: 'Tutores de tu propia universidad. Sesiones presenciales u online, con certificados únicos.',
              accent: 'linear-gradient(135deg, #0E7490, #06B6D4)',
              dot: '#67E8F9',
            },
            {
              title: 'Bolsa de trabajo',
              sub: 'Prácticas y empleos exclusivos para universitarios. CV profesional integrado, listo para usar.',
            ...
            >
              ...
              <h3 style={{ fontSize: 15, fontWeight: 700, margin: '0 0 9px', color: '#fff' }}>
                {f.title}
              </h3>
              <p
                style={{
      ...
      <section
        style={{
          padding: '0 clamp(20px,5vw,48px) clamp(56px,8vw,80px)',
          maxWidth: 1000,
          margin: '0 auto',
        }}
      >
      ...
      >
        {tabs.map((t) => (
          <button
            ...
            style={{
              background: active === t.id ? '#2D62C8' : 'transparent',
