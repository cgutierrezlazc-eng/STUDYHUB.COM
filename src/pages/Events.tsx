    ...
    <>
      <div className="page-header page-enter">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <h2>
              {Calendar({ size: 20 })} {t('events.title')}
            </h2>
      ...
      <div className="page-body">
        {loading ? (
          ...
          <div className="empty-state" style={{ padding: 40 }}>
            ...
            <button className="btn btn-primary empty-state-cta" onClick={() => setShowCreate(true)}>
              {t('events.create')}
            </button>
          </div>
        ) : (
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    >
                      ...
                      <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4 }}>
                        ...
                        {event.maxAttendees ? `/${event.maxAttendees}` : ''} {t('events.attendees')}
                      </span>
                      {event.organizer && (
                        <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4 }}>
                          <span
