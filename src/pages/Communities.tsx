...
export default function Communities({ onNavigate }: Props) {
  ...
  const categoryColor = (cat: string) =>
    CATEGORIES.find((c) => c.value === cat)?.color || '#6366f1';
      ...
      <div className="page-header page-enter">
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <div>
            ...
            <p style={{ margin: 0 }}>
              {t('communities.subtitle') || 'Grupos de estudio, materias y más'}
            </p>
          </div>
          <button
        ...
        {loading ? (
          ...
          >
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
                style={{ background: 'var(--bg-card)', borderRadius: 14, overflow: 'hidden' }}
              >
          ...
          <div style={{ textAlign: 'center', padding: '48px 0' }}>
            ...
            <div style={{ color: 'var(--text-muted)', fontSize: 14, marginBottom: 20 }}>
              {tab === 'my'
                ...
                : 'Sé el primero en crear una comunidad para tu área'}
            </div>
            <button
              className="btn btn-primary"
              onClick={() => (tab === 'my' ? setTab('explore') : setShowCreate(true))}
            >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              <div className="auth-field">
                ...
                <input
                  ...
                  placeholder="Ej: Cálculo I - UCH 2025"
                />
              </div>
              <div className="auth-field">
