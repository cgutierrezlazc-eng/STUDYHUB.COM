...
export default function TermsOfService({ onNavigate }: Props) {
  return (
    <div style={styles.container}>
      ...
      <p style={styles.p}>
        Bienvenido/a a Conniku. Al acceder y utilizar nuestra plataforma, usted acepta los presentes
        Términos y Condiciones de Uso (en adelante, los "Términos"). Si no está de acuerdo con estos
        Términos, le rogamos no utilizar el servicio.
      </p>

      {/* 1. Identidad */}
      <h2 style={styles.h2}>1. Identificación del Prestador</h2>
      <p style={styles.p}>
        El presente sitio web y la plataforma Conniku son operados por <strong>Conniku SpA</strong>,
        sociedad constituida conforme a las leyes de la República de Chile, con domicilio en Santiago,
        Chile. El servicio se encuentra disponible a través del sitio web{' '}
        <a href="https://conniku.com" style={{ color: '#2D62C8' }}>conniku.com</a>.
      </p>

      {/* 2. Objeto */}
      <h2 style={styles.h2}>2. Objeto del Servicio</h2>
      <p style={styles.p}>
        Conniku es una plataforma digital de estudio diseñada para estudiantes universitarios.
        El servicio permite organizar materias y proyectos académicos, generar resúmenes y material
        de estudio asistido por inteligencia artificial, participar en comunidades académicas,
      ...
      <p style={styles.p}>
        Para acceder a las funcionalidades de Conniku, el usuario debe crear una cuenta proporcionando
      ...
      <ul style={styles.ul}>
        ...
        <li>Proporcionar datos veraces al momento del registro. La entrega de información falsa podrá
          resultar en la suspensión o eliminación de la cuenta.</li>
      </ul>
      <p style={styles.p}>
        El usuario debe ser mayor de 16 años para crear una cuenta. Al registrarse, declara cumplir
        con este requisito.
      </p>
      ...
      <p style={styles.p}>
        Conniku ofrece los siguientes planes de suscripción:
      </p>
      <ul style={styles.ul}>
      ...
      <p style={styles.p}>
        ...
        Los pagos se procesan de forma recurrente mensual a través de los medios de pago habilitados
        en la plataforma. El usuario podrá cancelar su suscripción en cualquier momento, manteniendo
        el acceso hasta el final del período ya pagado.
      </p>
      <p style={styles.p}>
      ...
      <p style={styles.p}>
        ...
        de sus licenciantes, y está protegido por las leyes de propiedad intelectual vigentes en Chile
        (Ley N° 17.336 sobre Propiedad Intelectual).
      </p>
      <h3 style={styles.h3}>5.2. Contenido Generado por Inteligencia Artificial</h3>
      <p style={styles.p}>
        Los resúmenes, cuestionarios y demás contenido generado por inteligencia artificial a través
        de la plataforma son herramientas de apoyo al estudio. Conniku no garantiza la exactitud,
      ...
      <ul style={styles.ul}>
        <li>Utilizar la plataforma para cometer plagio académico o cualquier forma de deshonestidad académica.</li>
        <li>Publicar, compartir o distribuir contenido ilegal, ofensivo, difamatorio, obsceno o que
          atente contra los derechos de terceros.</li>
        <li>Enviar spam, mensajes masivos no solicitados o publicidad no autorizada.</li>
        <li>Intentar acceder de manera no autorizada a sistemas, cuentas o datos de otros usuarios.</li>
      ...
      <p style={styles.p}>
        ...
        el tratamiento de sus datos conforme a dicha política y a la Ley N° 19.628 sobre Protección
        de la Vida Privada.
      </p>
      ...
      <p style={styles.p}>
        Conniku SpA presta el servicio "tal como está" (as is) y "según disponibilidad" (as available).
        En la máxima medida permitida por la legislación chilena:
      </p>
      <ul style={styles.ul}>
        <li>Conniku no garantiza que el servicio sea ininterrumpido, libre de errores o completamente seguro.</li>
        <li>Conniku no se hace responsable por los resultados académicos del usuario ni por decisiones
          tomadas con base en el contenido generado por la plataforma.</li>
        <li>Conniku no será responsable por daños indirectos, incidentales, especiales o consecuenciales
          derivados del uso o imposibilidad de uso del servicio.</li>
        <li>La responsabilidad total de Conniku frente al usuario no excederá el monto pagado por el
          usuario en los últimos 12 meses por el servicio.</li>
      </ul>
      ...
      <p style={styles.p}>
        ...
        aceptación de los nuevos Términos. Si el usuario no está de acuerdo con las modificaciones,
        deberá dejar de utilizar el servicio y eliminar su cuenta.
      </p>
      ...
      <p style={styles.p}>
        ...
        al conocimiento de los Tribunales Ordinarios de Justicia de la ciudad de Santiago de Chile,
        renunciando las partes a cualquier otro fuero que pudiere corresponderles.
      </p>

      {/* 12. Disposiciones generales */}
      <h2 style={styles.h2}>12. Disposiciones Generales</h2>
      <p style={styles.p}>
        Si cualquier disposición de estos Términos fuere declarada nula o inaplicable, las restantes
        disposiciones mantendrán su plena vigencia y efecto. La falta de ejercicio por parte de
        Conniku de cualquier derecho establecido en estos Términos no constituirá una renuncia a
        dicho derecho.
      </p>
      ...
      <ul style={styles.ul}>
        <li>Correo electrónico: <a href="mailto:contacto@conniku.com" style={{ color: '#2D62C8' }}>contacto@conniku.com</a></li>
