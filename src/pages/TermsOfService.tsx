  ...
  return (
    <div style={styles.container}>
      ...
      <p style={styles.p}>
        ...
        Santiago, Chile. El servicio se encuentra disponible a través del sitio web{' '}
      ...
      <ul style={styles.ul}>
        ...
        <li>
          Proporcionar datos veraces al momento del registro. La entrega de información falsa podrá
      ...
      <ul style={styles.ul}>
        ...
        <li>
          <strong>Pro:</strong> $4.990 CLP mensuales. Incluye funcionalidades avanzadas de estudio,
          generación de contenido asistido y acceso prioritario a nuevas herramientas.
        </li>
        <li>
      ...
      <p style={styles.p}>
        Los precios están expresados en pesos chilenos (CLP) e incluyen IVA cuando corresponda. Los
        pagos se procesan de forma recurrente mensual a través de los medios de pago habilitados en
        la plataforma. El usuario podrá cancelar su suscripción en cualquier momento, manteniendo el
      ...
      <p style={styles.p}>
        ...
        textos, gráficos, logotipos, íconos e interfaz de usuario, es propiedad de Conniku SpA o de
        sus licenciantes, y está protegido por las leyes de propiedad intelectual vigentes en Chile
      ...
      <p style={styles.p}>
        ...
        suba a la plataforma. Al cargar contenido, el usuario otorga a Conniku una licencia
      ...
      <ul style={styles.ul}>
        <li>
          Conniku no garantiza que el servicio sea ininterrumpido, libre de errores o completamente
          seguro.
        </li>
        <li>
          Conniku no se hace responsable por los resultados académicos del usuario ni por decisiones
          tomadas con base en el contenido generado por la plataforma.
        </li>
        <li>
      ...
      <p style={styles.p}>
        ...
        controversia derivada de la interpretación o cumplimiento de estos Términos será sometida al
        conocimiento de los Tribunales Ordinarios de Justicia de la ciudad de Santiago de Chile,
      ...
      <p style={styles.p}>
        Para cualquier consulta relacionada con estos Términos y Condiciones, puede comunicarse con
