...
export default function DeleteAccount({ onNavigate }: Props) {
  return (
    <div style={styles.container}>
      ...
      <p style={styles.p}>
        Si no puedes acceder a la aplicación, puedes solicitar la eliminación de tu cuenta enviando
        un correo a nuestro equipo de privacidad:
      </p>
      ...
      <div style={styles.infoBox}>
        ...
        dirección registrada cuando la eliminación haya sido procesada. El plazo máximo de respuesta
        es de <strong>30 días corridos</strong> desde la recepción de tu solicitud.
      </div>
