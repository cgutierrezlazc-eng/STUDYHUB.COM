                  ...
                  {ranking.map((t: any, i: number) => {
                    ...
                    return (
                      <div
                        ...
                        onMouseLeave={(e) =>
                          t.username && ((e.currentTarget as HTMLElement).style.boxShadow = 'none')
                        }
                      >
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          >
                            <span style={{ fontSize: 12, fontWeight: 700, color: medalColors[i] }}>
          ...
          >
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, alignItems: 'center' }}>
              ...
              <div style={{ marginLeft: 'auto', fontSize: 13, color: 'var(--text-tertiary)' }}>
                {filteredTutors.length} tutor{filteredTutors.length !== 1 ? 'es' : ''} encontrado
              ...
              {filteredTutors.map((tutor) => {
                ...
                return (
                  ...
                  >
                    {/* Card top accent */}
                    <div
                      style={{ height: 4, background: 'linear-gradient(90deg, #f59e0b, #d97706)' }}
                    />
                ...
                <div style={{ padding: '24px 28px' }}>
                  ...
                  <div style={{ display: 'flex', gap: 18, marginBottom: 20 }}>
                    ...
                    <div>
                      ...
                      {selectedTutor.institution && (
                        <p
                          style={{ fontSize: 13, color: 'var(--text-tertiary)', margin: '0 0 8px' }}
                        >
                          {selectedTutor.institution}
                        </p>
                      )}
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    <div style={{ display: 'flex', gap: 12 }}>
                      ...
                      >
                        <p
                          style={{ fontSize: 12, color: 'var(--text-tertiary)', margin: '0 0 4px' }}
                        >
                          Individual
                        </p>
                        <p style={{ fontSize: 20, fontWeight: 700, color: '#d97706', margin: 0 }}>
                          {formatPrice(selectedTutor.pricePerHour)}
                        </p>
                        <p
                          style={{ fontSize: 11, color: 'var(--text-tertiary)', margin: '2px 0 0' }}
                        >
                          por hora
                        </p>
                      </div>
              ...
              {bookingSuccess ? (
                <div style={{ textAlign: 'center', padding: '20px 0' }}>
                  ...
                  <p style={{ fontSize: 14, color: 'var(--text-secondary)', margin: '0 0 20px' }}>
                    Tu solicitud fue enviada a {bookingTutor.firstName}. Recibiras una confirmacion
                    pronto.
                  </p>
                  <button
                    onClick={() => setShowBookingModal(false)}
                  ...
                  >
                    ...
                    >
                      <span style={{ fontSize: 13, color: 'var(--text-secondary)' }}>
                        Clase ({bookingType === 'individual' ? 'individual' : 'grupal'}) - 1 hora
                      </span>
                      <span style={{ fontSize: 13, fontWeight: 600, color: 'var(--text-primary)' }}>
        ...
        >
          ...
          >
            ...
            >
              ...
              {ratingModal.students.filter((s) => s.payment_status === 'paid').length} estudiante
