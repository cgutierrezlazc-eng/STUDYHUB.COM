 ...
 * Terms.tsx
 *
 * Traducción de ORBIT-U/pages/terminos.html (385 líneas) a un componente
 * React funcional. Bridging del módulo M01.1 · Términos de servicio.
 *
 * Reglas observadas:
 * - El contenido legal es VIGENTE y aprobado por el abogado · NO modificar
 *   texto. Cada artículo, cláusula y palabra es idéntica al original.
 * - Idioma: español neutro latinoamericano (sin voseo).
 * - Logo oficial: estructura inviolable de `<span class="brand on-dark">`
 *   con className global (no CSS module) · CSS vive en
 *   `src/styles/ConnikuWordmark.css` cargado globalmente desde main.tsx.
 *
 ...
 * - Bridging de las páginas legales hermanas (privacidad, cookies) · por
 *   ahora los enlaces del footer apuntan a `/` (UnderConstruction).
 * - Backend de tracking de aceptación · esta página es solo lectura pública.
 */
...
export default function Terms() {
  return (
    <div className={styles.page}>
      ...
      <div className={styles.layout}>
        ...
        <main className={styles.docBody}>
          ...
          <div className={`${styles.infoBox} ${styles.green}`}>
            ...
            comercial, y no debes publicar contenido que cause daño a terceros. Si pagas por un plan
            premium tienes derecho a retracto durante 10 días corridos contados desde la
          ...
          <p>
            ...
            Antofagasta, Chile (en adelante "Conniku" o "la Empresa"), y la persona natural mayor de
            18 años que se registra o utiliza la plataforma (en adelante "el Usuario").
          </p>

          <h3>Artículo 2. Objeto</h3>
          <p>
            Conniku es una plataforma digital colaborativa para educación universitaria cuyo objeto
            social es el{' '}
            <em>
          ...
          <p>
            El servicio está dirigido exclusivamente a personas mayores de <strong>18 años</strong>.
            Conniku no presta servicios a menores de edad. Si Conniku detecta que un Usuario
            registrado es menor de 18 años, suspenderá la cuenta de forma inmediata y eliminará los
            datos asociados conforme a la Política de Privacidad.
          </p>
          ...
          <p>
            ...
            mantener sus credenciales de acceso en reserva y de cualquier actividad realizada desde
            su cuenta.
          </p>

          <h3>Artículo 6. Veracidad de datos</h3>
          <p>
            El Usuario declara bajo su responsabilidad que toda la información proporcionada durante
            el registro es veraz. Conniku se reserva el derecho de verificar la información y de
            suspender o eliminar cuentas creadas con información falsa o que infrinjan derechos de
            terceros.
          </p>
          ...
          <p>
            Conniku pone a disposición del Usuario los siguientes módulos, cuya disponibilidad puede
            variar según el plan suscrito y la etapa de desarrollo de la plataforma:
          </p>
          <ul>
            <li>
              <strong>Workspaces:</strong> espacios colaborativos para grupos de estudio y proyectos
              académicos.
            </li>
            <li>
          ...
          <p>
            ...
            Conniku una licencia mundial, no exclusiva, gratuita, sublicenciable y transferible para
            usar, reproducir, distribuir, preparar obras derivadas y mostrar dicho contenido
          ...
          <p>
            ...
            transmite a través de la plataforma. Conniku actúa como intermediario técnico y no asume
            responsabilidad editorial por el contenido generado por los usuarios.
          </p>
          ...
          <ul>
            ...
            <li>Contenga material de abuso sexual infantil (CSAM) o pornografía no consentida.</li>
            <li>
          ...
          <p>
            ...
            propios y cualquier otro elemento de propiedad intelectual son titularidad exclusiva de
            Conniku SpA o de sus licenciantes, protegidos por la Ley N° 17.336 sobre Propiedad
          ...
          <p>
            ...
            ingeniería inversa, el scraping masivo, la copia, redistribución o explotación comercial
            de cualquier elemento de la plataforma sin autorización escrita de Conniku.
          </p>
          ...
          <p>
            ...
            normas de convivencia establecidas en las directrices de comunidad de Conniku, actuando
            de buena fe y sin causar daño a otros usuarios o a la plataforma.
          </p>
          ...
          <p>
            ...
            corridos siguientes a la notificación.
          </p>
          ...
          <p>
            ...
            académica y usuarios que la solicitan. Conniku actúa como intermediario tecnológico. Los
            tutores que prestan servicios a través de la plataforma no son empleados ni
          ...
          <p>
            Los pagos se procesan a través de proveedores terceros (MercadoPago, PayPal u otros que
            Conniku indique). Conniku no almacena datos de tarjetas de crédito ni información
          ...
          <div className={`${styles.infoBox} ${styles.orange}`}>
            <strong>Importante.</strong> El derecho de retracto se extingue en el momento en que el
            Usuario comienza a utilizar efectivamente el servicio o módulo premium contratado,
            conforme al Art. 3 bis inciso final de la Ley 19.496.
          </div>

          <h3>Artículo 25. Procedimiento de retracto</h3>
          <p>
            Para ejercer el derecho de retracto, el Usuario debe notificar su decisión por escrito a{' '}
            <a href="mailto:soporte@conniku.com">soporte@conniku.com</a> dentro del plazo indicado.
            Conniku procederá al reembolso mediante el mismo medio de pago utilizado en la compra,
          ...
          <p>
            ...
            estatutarias, incluyendo garantías de comerciabilidad, idoneidad para un fin particular
            o no infracción.
          </p>
          ...
          <p>
            ...
            controla ni es responsable del contenido, políticas de privacidad o prácticas de sitios
            web de terceros.
          </p>
          ...
          <p>
            ...
            compromiso con la prevención del acoso laboral, acoso sexual y violencia en el trabajo,
            conforme a la <strong>Ley N° 21.643 (Ley Karin)</strong>, vigente desde el 1 de agosto
            de 2024.
          </p>
          ...
          <p>
            Toda denuncia recibida será investigada conforme al procedimiento establecido en la Ley
            Karin, con respeto a los derechos de todas las partes involucradas. Conniku se reserva
            el derecho de suspender o terminar la cuenta del Usuario sobre el que recaiga una
            denuncia fundada, sin perjuicio de las acciones legales que correspondan.
          </p>
          ...
          <p>
            ...
            <strong>Ley 21.643</strong> (Ley Karin), la <strong>Ley 17.336</strong> sobre Propiedad
            Intelectual, y la <strong>Ley 21.719</strong> sobre Protección y Tratamiento de Datos
            Personales (vigente a partir del 1 de diciembre de 2026).
          </p>
          ...
          <p>
            ...
            plena vigencia. La disposición inválida se modificará en la medida mínima necesaria para
            hacerla válida y ejecutable.
          </p>
      ...
      {/* Footer · TODO: cuando se bridgeen privacidad/cookies/soporte/contacto/prensa/empleo */}
