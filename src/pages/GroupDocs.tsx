...
import { FileText, Plus, Users, Search, Trash2, Pencil, Check, X, Clock, Crown } from '../components/Icons'
...
const COLORS = ['#2D62C8', '#E53E3E', '#38A169', '#D69E2E', '#805AD5', '#DD6B20', '#319795', '#E53E84']
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
        ...
        <button
          ...
          style={{
            ...
            background: '#2D62C8', color: '#fff', fontSize: 14, fontWeight: 600,
            cursor: 'pointer',
          }}
        >
            ...
            <div style={{ display: 'flex', gap: 8, marginBottom: 16, flexWrap: 'wrap' }}>
              {COLORS.map(c => (
                <button
                  ...
                  onClick={() => setColor(c)}
                  style={{
                    width: 32, height: 32, borderRadius: '50%', border: color === c ? '3px solid var(--text-primary)' : '2px solid transparent',
              ...
              {searchResults.length > 0 && (
                <div style={{
                  ...
                  {searchResults.map((r: any) => (
                    ...
                    >
                      <div style={{
                        width: 32, height: 32, borderRadius: '50%', background: '#2D62C8',
            ...
            <div style={{ display: 'flex', gap: 10, justifyContent: 'flex-end' }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: title.trim() ? '#2D62C8' : '#555', color: '#fff',
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    {editingId === doc.id ? (
                      <div style={{ display: 'flex', gap: 4 }} onClick={e => e.stopPropagation()}>
                        ...
                        />
                        <button onClick={() => handleRename(doc.id)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#38A169', padding: 2 }}>
                          {Check({ size: 16 })}
                        </button>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    ...
                    <div style={{ display: 'flex' }}>
                      ...
                      {doc.members.length > 4 && (
                        <div style={{
                          width: 26, height: 26, borderRadius: '50%',
                          background: 'var(--bg-primary)', border: '2px solid var(--bg-secondary)',
                          display: 'flex', alignItems: 'center', justifyContent: 'center',
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    ...
                    {doc.ownerId === user?.id && (
                      <div style={{ display: 'flex', gap: 2 }} onClick={e => e.stopPropagation()}>
                        ...
                        <button
                          onClick={() => { if (confirm('Eliminar este documento?')) handleDelete(doc.id) }}
