    ...
    <div className={styles.page}>
      ...
      <div className={styles.layout}>
        ...
        <aside className={styles.sidebar}>
          ...
          <div className={styles.dCard}>
            <div className={styles.cardLabel}>Contacto DPO</div>
            <p className={styles.cardText}>
              Para solicitudes de privacidad y ejercicio de derechos ARCO+ escríbenos a{' '}
              <a href="mailto:privacidad@conniku.com">privacidad@conniku.com</a> o al DPO en{' '}
        ...
        <main className={styles.feed}>
          <div className={styles.dCard}>
            ...
            <div className={`${styles.infoBox} ${styles.green}`}>
              ...
              el servicio. No vendemos tu información. Tienes derecho a acceder, corregir, eliminar
              y portar tus datos en cualquier momento. Respondemos en 2 días hábiles para
              solicitudes urgentes (Chile) y en máximo 30 días para el resto. Escríbenos a{' '}
            ...
            <p>
              El Delegado de Protección de Datos (DPO) de Conniku puede ser contactado directamente
              en <a href="mailto:dpo@conniku.com">dpo@conniku.com</a> para consultas relacionadas
              con el tratamiento de datos, ejercicio de derechos o reclamaciones formales.
            </p>
            ...
            <ul>
              <li>
                <strong>Datos técnicos:</strong> dirección IP (pseudonimizada a los 12 meses), tipo
                de navegador, sistema operativo, idioma, zona horaria.
              </li>
              <li>
            ...
            <div className={styles.tableWrap}>
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <strong>Personalización</strong> (preferencias de idioma, tema visual, orden
                      del feed)
                    </td>
                    <td>Ejecución del contrato — Art. 6(1)(b) GDPR</td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <strong>Comunicaciones comerciales</strong> (novedades, funcionalidades
                      nuevas, ofertas)
                    </td>
            ...
            <ul>
              ...
              <li>
                ...
                cuando ya no sean necesarios o cuando retires el consentimiento, sujeto a
                excepciones legales.
              </li>
              <li>
              ...
              <li>
                ...
                por máquina (JSON o CSV).
              </li>
              <li>
                <strong>Limitación del tratamiento:</strong> solicitar que el tratamiento se
                restrinja en casos específicos (GDPR Art. 18).
              </li>
              <li>
            ...
            <div className={`${styles.infoBox} ${styles.green}`}>
              ...
              <a href="mailto:privacidad@conniku.com">privacidad@conniku.com</a> indicando tu
              nombre, correo registrado y el derecho que deseas ejercer. Conniku responderá en
              máximo 2 días hábiles (Chile, trámites urgentes), 15 días hábiles (Chile, trámites
              ordinarios) o 30 días calendario (GDPR), prorrogable por 60 días adicionales en casos
            ...
            <ul>
              ...
              <li>
                <strong>Unión Europea / EEE:</strong> la autoridad de control del Estado miembro
                donde residas.
              </li>
              <li>
            ...
            <p>
              ...
              Art. 33 GDPR; notificación al afectado sin dilación indebida cuando el riesgo sea
              alto, conforme al Art. 34 GDPR).
            </p>

            {/* §9 */}
            <h2 id="s9">§9 — Menores de edad</h2>
            <p>
              Conniku no presta servicios a personas menores de <strong>18 años</strong> y no
              recopila datos personales de menores a sabiendas. Si Conniku detecta que ha recibido
              datos de un menor de 18 años sin consentimiento parental verificable, procederá a
              eliminar esos datos de forma inmediata.
            </p>
            <p>
            ...
            <div className={styles.infoBox} style={{ marginTop: 40 }}>
              <strong>Documento:</strong> Política de Privacidad · Versión 2.4.2 · Vigente desde el
              23 de abril de 2026
              <br />
