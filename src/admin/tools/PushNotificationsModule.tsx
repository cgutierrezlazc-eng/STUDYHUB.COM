...
const TEMPLATES = [
  {
    id: 'update',
    icon: '🔄',
    title: 'Actualiza tu App Conniku',
    body: 'Hemos actualizado el logo oficial y mejorado la plataforma. Actualiza para ver los cambios.',
    url: '/',
  },
  {
    id: 'feature',
    ...
    body: 'Descubre las nuevas herramientas de estudio que hemos preparado para ti.',
    url: '/dashboard',
  },
  {
    id: 'event',
    ...
    body: 'No te pierdas el evento de esta semana. ¡Inscríbete ahora!',
    url: '/events',
  },
  {
    id: 'promo',
    ...
    body: 'Aprovecha nuestra promoción por tiempo limitado. Mejora tu plan ahora.',
    url: '/subscription',
  },
];
...
export default function PushNotificationsModule() {
  ...
  const [sentHistory, setSentHistory] = useState<
    { title: string; body: string; sentAt: string; count: number }[]
  >([
    {
      title: '🔄 Actualiza tu App Conniku',
      body: 'Hemos actualizado el logo oficial...',
      sentAt: '2026-04-07 14:30',
      count: 127,
    },
    {
      title: '✨ Nuevo: Asistente de Estudio Conniku',
      body: 'Prueba el nuevo asistente...',
      sentAt: '2026-04-05 10:00',
      count: 98,
    },
    {
      title: '📅 Hackathon Conniku 2026',
      body: 'Inscríbete al hackathon...',
  ...
  const sendPush = async (title: string, body: string, url: string) => {
    ...
    try {
      ...
      setSentHistory((prev) => [
        { title, body, sentAt: new Date().toLocaleString('es-CL'), count: 0 },
        ...prev,
      ]);
