...
export default function ContabilidadTab() {
  ...
  const [activeView, setActiveView] = useState<'compras' | 'ventas' | 'resumen' | 'plan_cuentas'>(
    'compras'
  );
  ...
  return (
    <div style={{ padding: '24px', maxWidth: 1400, margin: '0 auto' }}>
            ...
            <>
              ...
              >
                ...
                <SummaryCard
                  ...
                  color="#3b82f6"
                  sub="IVA recuperable de compras"
                />
              </div>
                  ...
                  <tbody>
                    ...
                    <tr style={{ color: '#3b82f6' }}>
                      <td style={{ padding: '8px 0' }}>
                        (-) Total IVA Credito Fiscal (compras con factura)
                      </td>
              ...
              <div className="u-card" style={{ padding: 20, marginBottom: 20 }}>
                ...
                <p style={{ fontSize: 12, color: 'var(--text-muted)', marginTop: 4 }}>
                  0,25% sobre ingresos brutos ({fmtCLP(summary.totalIngresos)}) — Tasa Micro Empresa
                  ProPyme
                </p>
              </div>
              ...
              <div
                style={{
                  ...
                  borderRadius: 14,
                  background:
                    summary.ivaAPagar + summary.ppm > 0
                      ? 'rgba(239,68,68,0.08)'
                      : 'rgba(34,197,94,0.08)',
              ...
              >
                <div style={{ fontSize: 13, color: 'var(--text-muted)', marginBottom: 4 }}>
                  Total a Declarar en F29
                </div>
                <div
                  style={{
                    fontSize: 28,
                    fontWeight: 800,
                    color: summary.ivaAPagar + summary.ppm > 0 ? '#ef4444' : '#22c55e',
                  }}
                >
      ...
      {activeView === 'plan_cuentas' && (
        <div>
          <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 16 }}>
            Plan de Cuentas — Contabilidad Simplificada
          </h2>
          <p style={{ fontSize: 12, color: 'var(--text-muted)', marginBottom: 16 }}>
            Regimen 14D N°3 ProPyme Transparente — base flujo de caja. Las categorias se alimentan
            automaticamente desde el modulo de transacciones.
          </p>
  ...
  return (
    <div>
      ...
      {transactions.length === 0 ? (
        <EmptyState
          message={`Sin ${direction === 'compra' ? 'compras' : 'ventas'} registradas para este periodo.`}
        />
      ) : (
              ...
              <thead>
                <tr style={{ background: 'var(--bg-secondary)' }}>
                  ...
                  <th style={{ ...thStyle, textAlign: 'left' }}>
                    {direction === 'compra' ? 'Proveedor' : 'Cliente'}
                  </th>
                  ...
                  <tr key={t.id} style={{ borderBottom: '1px solid var(--border)' }}>
                    ...
                    <td
                      style={{
                        ...
                        color: t.iva > 0 ? '#f59e0b' : 'var(--text-muted)',
                      }}
                    >
