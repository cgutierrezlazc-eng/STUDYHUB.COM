...
export default function FacturacionTab() {
  ...
  const [newItems, setNewItems] = useState([
    { descripcion: '', cantidad: 1, precioUnit: 0, total: 0 },
  ]);
    ...
    return facturas.filter((f) => {
      ...
      if (searchQuery) {
        ...
        if (
          ...
          !f.rutReceptor.includes(q) &&
          !f.folio.toString().includes(q)
        )
          return false;
      }
      return true;
      ...
      {activeView === 'facturas' && selectedFactura && (
        <div>
          <button
            ...
            style={{ ...btnSmall, marginBottom: 16 }}
          >
            ← Volver al listado
          </button>
          <div
          ...
          >
              ...
              >
                <div>
                  <h2 style={{ fontSize: 18, fontWeight: 800, margin: 0 }}>
                    {DTE_TYPES.find((t) => t.code === selectedFactura.tipo)?.label} N°{' '}
                    {selectedFactura.folio}
                  </h2>
                ...
                <span
                  style={{
                    ...
                    fontSize: 11,
                    fontWeight: 600,
                    ...estadoStyle(selectedFactura.estado),
                    textTransform: 'capitalize',
                  }}
                >
            ...
            <div style={{ padding: '16px 24px', borderBottom: '1px solid var(--border)' }}>
              ...
              <div style={{ fontSize: 12, color: 'var(--text-muted)' }}>
                RUT: {selectedFactura.rutReceptor} — {selectedFactura.giro}
              </div>
            </div>
            ...
            >
              <div style={{ display: 'flex', gap: 40, fontSize: 13 }}>
                ...
                <span style={{ fontWeight: 600, minWidth: 100, textAlign: 'right' }}>
                  ${fmt(selectedFactura.neto)}
                </span>
              </div>
              <div style={{ display: 'flex', gap: 40, fontSize: 13 }}>
                <span style={{ color: 'var(--text-muted)' }}>IVA 19%</span>
                <span style={{ fontWeight: 600, minWidth: 100, textAlign: 'right' }}>
                  ${fmt(selectedFactura.iva)}
                </span>
              </div>
              <div
                style={{
              ...
              >
                <span>TOTAL</span>
                <span style={{ minWidth: 100, textAlign: 'right', color: 'var(--accent)' }}>
                  ${fmt(selectedFactura.total)}
                </span>
              </div>
            </div>
          </div>
      ...
      {activeView === 'nueva' && (
        <div style={{ maxWidth: 700 }}>
          ...
          >
            ...
            <span>
              <strong>Próximamente:</strong> La emisión de DTE requiere integración con el SII
              mediante certificado digital. Por ahora puedes generar borradores y exportarlos.
            </span>
          </div>
                ...
                >
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      n[i].total = n[i].cantidad * n[i].precioUnit;
                      setNewItems(n);
                    }}
                    style={inputStyle}
                  />
          ...
          >
            ...
            <div style={{ display: 'grid', gap: 8 }}>
              {[
                ...
                >
                  <span style={{ fontSize: 13, fontWeight: item.bold ? 700 : 400 }}>
                    {item.label}
                  </span>
                  <span
                    style={{
