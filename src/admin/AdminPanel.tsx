...
const ICON_MAP: Record<string, (c: string) => React.ReactNode> = {
  ...
  'clipboard-list': (c) => (
    <DI c={c}>
      <rect x="5" y="2" width="14" height="20" rx="2" fill={`${c}20`} />
      <path d="M9 2h6" />
  ...
  calendar: (c) => (
    <DI c={c}>
      <rect x="3" y="4" width="18" height="18" rx="2" fill={`${c}20`} />
  ...
  'folder-open': (c) => (
    <DI c={c}>
      <path d="M2 19V5a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v2" fill={`${c}20`} />
      <path d="M2 19l2.5-7h17l-2.5 7H2z" fill={`${c}15`} />
    </DI>
  ),
  star: (c) => (
    <DI c={c}>
  ...
  target: (c) => (
    <DI c={c}>
      <circle cx="12" cy="12" r="10" fill={`${c}15`} />
      <circle cx="12" cy="12" r="6" fill={`${c}20`} />
  ...
  banknote: (c) => (
    <DI c={c}>
      <rect x="2" y="6" width="20" height="12" rx="2" fill={`${c}20`} />
  ...
  landmark: (c) => (
    <DI c={c}>
      <path d="M12 2L2 7h20L12 2z" fill={`${c}20`} />
  ...
  'bar-chart': (c) => (
    <DI c={c}>
      <rect x="3" y="12" width="4" height="9" rx="1" fill={`${c}20`} />
      <rect x="10" y="7" width="4" height="14" rx="1" fill={`${c}30`} />
      <rect x="17" y="3" width="4" height="18" rx="1" fill={`${c}20`} />
    </DI>
  ),
  'file-check': (c) => (
    <DI c={c}>
  ...
  receipt: (c) => (
    <DI c={c}>
      <path d="M4 2v20l3-2 3 2 3-2 3 2 3-2V2l-3 2-3-2-3 2-3-2-3 2z" fill={`${c}20`} />
  ...
  shield: (c) => (
    <DI c={c}>
      <path d="M12 2l8 4v6c0 5.25-3.5 9.5-8 11-4.5-1.5-8-5.75-8-11V6l8-4z" fill={`${c}20`} />
    </DI>
  ),
  'trending-up': (c) => (
    <DI c={c}>
  ...
  'credit-card': (c) => (
    <DI c={c}>
      <rect x="1" y="4" width="22" height="16" rx="2" fill={`${c}20`} />
  ...
  calculator: (c) => (
    <DI c={c}>
      <rect x="4" y="2" width="16" height="20" rx="2" fill={`${c}20`} />
      <rect x="7" y="5" width="10" height="4" rx="1" />
      <line x1="7" y1="13" x2="7" y2="13" strokeWidth="2.5" strokeLinecap="round" />
      <line x1="12" y1="13" x2="12" y2="13" strokeWidth="2.5" strokeLinecap="round" />
      <line x1="17" y1="13" x2="17" y2="13" strokeWidth="2.5" strokeLinecap="round" />
      <line x1="7" y1="17" x2="7" y2="17" strokeWidth="2.5" strokeLinecap="round" />
      <line x1="12" y1="17" x2="12" y2="17" strokeWidth="2.5" strokeLinecap="round" />
      <line x1="17" y1="17" x2="17" y2="17" strokeWidth="2.5" strokeLinecap="round" />
    </DI>
  ),
  'pie-chart': (c) => (
    <DI c={c}>
      <path d="M21.21 15.89A10 10 0 1 1 8 2.83" fill={`${c}20`} />
      <path d="M22 12A10 10 0 0 0 12 2v10z" fill={`${c}30`} />
    </DI>
  ),
  scale: (c) => (
    <DI c={c}>
      <path d="M12 3v19" />
      <path d="M5 8l7-5 7 5" />
      <path d="M3 14l2-6 2 6a3 3 0 0 1-4 0z" fill={`${c}20`} />
      <path d="M17 14l2-6 2 6a3 3 0 0 1-4 0z" fill={`${c}20`} />
    </DI>
  ),
  search: (c) => (
    <DI c={c}>
  ...
  mail: (c) => (
    <DI c={c}>
      <rect x="2" y="4" width="20" height="16" rx="2" fill={`${c}20`} />
  ...
  bell: (c) => (
    <DI c={c}>
      <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" fill={`${c}20`} />
...
export default function AdminPanel({ onNavigate }: Props) {
  ...
  if (!user || (user.role !== 'owner' && user.role !== 'admin' && user.role !== 'employee')) {
    return (
      <div style={{ padding: 40, textAlign: 'center', color: 'var(--text-muted)' }}>
        ...
        <p>
          Solo CEO, administradores y empleados autorizados pueden acceder al Panel de
          Administración.
        </p>
      </div>
    );
  ...
  return (
    <div className="page-enter" style={{ padding: '24px 32px', maxWidth: 1400, margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: 28 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
          <svg
            ...
            strokeLinejoin="round"
          >
            <rect x="3" y="3" width="7" height="7" rx="1" fill="rgba(37,99,235,0.15)" />
            <rect x="14" y="3" width="7" height="7" rx="1" />
            <rect x="3" y="14" width="7" height="7" rx="1" />
            <rect x="14" y="14" width="7" height="7" rx="1" fill="rgba(37,99,235,0.15)" />
          </svg>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: 14, margin: 0 }}>
          Conniku SpA — Gestión integral de personas, remuneraciones, finanzas y compliance. Cada
          módulo se abre en una ventana independiente.
        </p>
      </div>
          ...
          >
            <svg
              ...
              style={{
                ...
                transform:
                  expandedCat === cat.key || !expandedCat ? 'rotate(90deg)' : 'rotate(0deg)',
              }}
            >
                    ...
                    <div style={{ flexShrink: 0, marginTop: 2 }}>
                      {ICON_MAP[mod.icon]
                        ? ICON_MAP[mod.icon](
                            comingSoon
                              ? 'var(--text-muted)'
                              : CAT_COLORS[mod.category] || 'var(--accent)'
                          )
      ...
      >
        <strong>Tip:</strong> Haz clic en cualquier módulo para acceder directamente. Los módulos
        marcados como <span style={{ color: 'var(--accent)', fontWeight: 600 }}>NUEVO</span> están
