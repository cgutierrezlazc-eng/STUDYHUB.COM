        ...
        <div style={{ flex: 1, overflow: 'auto', padding: 24 }}>
          ...
          {activeTab === 'jornada' && (
            <div>
              ...
              >
                ...
                22 inc. 2: excluye de limitacion a gerentes, teletrabajadores que distribuyen
                libremente su jornada, y otros.
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                <div style={{ ...fieldStyle, gridColumn: 'span 2' }}>
          ...
          {activeTab === 'liquidacion' &&
            (() => {
              ...
              // Cotizaciones
              const afpAmt = Math.round(
                (Math.min(totalImponible, CHILE_LABOR.TOPES.afpCLP) * afpRatePct) / 100
              );
              const saludAmt =
                form.healthSystem === 'isapre'
              ...
              const afcEmpAmt = form.afcActive
                ? Math.round(
                    Math.min(totalImponible, CHILE_LABOR.TOPES.afcCLP) *
                      (form.contractType === 'indefinido' ? CHILE_LABOR.AFC.employeeRate : 0)
                  )
                : 0;
              ...
              const mutualAmt = Math.round(
                totalImponible * (CHILE_LABOR.MUTUAL.baseRate + CHILE_LABOR.MUTUAL.additionalRate)
              );
              ...
              const anticipoAmt = form.anticipoQuincenal
                ? Math.round((sueldoLiquido * form.anticipoPct) / 100)
                : 0;
              ...
              return (
                <div>
                  ...
                  >
                    ...
                    — Art. 41-52 CT, DL 3.500, Ley 18.469, Ley 19.728.
                    <br />
                    Esta liquidación se generará automáticamente y se enviará al correo del
                    trabajador el <strong>último día hábil de cada mes</strong>.
                  </div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <tbody>
                          ...
                          {row(
                            `Gratificación legal (Art.50 — tope ${gratMensual.toLocaleString('es-CL')})`,
                            gratMensual
                          )}
                          <tr style={{ borderTop: '1px solid var(--border)' }}>
                            <td style={{ padding: '6px 10px', fontSize: 12, fontWeight: 700 }}>
                            ...
                            >
                              ${totalImponible.toLocaleString('es-CL')}
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            >
                              ${(totalImponible + haberesNoImponibles).toLocaleString('es-CL')}
                            </td>
                          </tr>
                        </tbody>
                      </table>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <tbody>
                          ...
                          {row(
                            form.healthSystem === 'isapre'
                              ? `Isapre ${form.isapreName || ''} (${form.isapreUf || 0} UF)`
                              : 'Fonasa (7%)',
                            -saludAmt,
                            '#ef4444'
                          )}
                          ...
                          >
                            ...
                            >
                              ${baseImpuesto.toLocaleString('es-CL')}
                            </td>
                          </tr>
                          {row(`Imp. 2a Categoría (Art.43 LIR)`, -taxAmt, '#ef4444')}
                          {form.pensionAlimentos &&
                            row(
                              `Pensión Alimentos (${form.pensionAlimentosBeneficiarios} benef.)`,
                              -pensionAmt,
                              '#f97316'
                            )}
                          {form.apvActive &&
                            row(`APV Régimen ${form.apvRegime}`, -apvAmt, '#8b5cf6')}
                          <tr style={{ borderTop: '2px solid var(--border)' }}>
                            ...
                            >
                              -${totalDescuentos.toLocaleString('es-CL')}
                            </td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  >
                    <div
                      style={{
                        ...
                        gap: 16,
                        marginBottom: form.anticipoQuincenal ? 12 : 0,
                      }}
                    >
                    ...
                    {form.anticipoQuincenal && (
                      ...
                      >
                        <span style={{ opacity: 0.8 }}>
                          Anticipo día 15 ({form.anticipoPct}%):{' '}
                          <strong>-${anticipoAmt.toLocaleString('es-CL')}</strong>
                        </span>
                        <span style={{ opacity: 0.8 }}>
                          Pago final mes:{' '}
                          <strong style={{ color: '#4ade80' }}>
                            ${pagoFinalMes.toLocaleString('es-CL')}
                          </strong>
                        </span>
                      </div>
                    )}
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        Costo Total Empleador / mes
                      </p>
                      <table style={{ width: '100%', fontSize: 12 }}>
                        <tbody>
                          <tr>
                            <td style={{ color: 'var(--text-muted)', paddingBottom: 2 }}>
                              Sueldo bruto + gratificación
                            </td>
                          ...
                          <tr>
                            ...
                            <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>
                              ${(sisAmt + mutualAmt).toLocaleString('es-CL')}
                            </td>
                          </tr>
                          <tr style={{ borderTop: '1px solid var(--border)', fontWeight: 700 }}>
                            ...
                            >
                              ${costoTotalEmpleador.toLocaleString('es-CL')}
                            </td>
                          </tr>
                        </tbody>
                      </table>
                    ...
                    >
                      ...
                      >
                        La liquidación mensual será enviada automáticamente a{' '}
                        <strong>{form.email || 'correo del trabajador'}</strong> el{' '}
                        <strong>último día hábil de cada mes</strong>, conforme al ciclo de
                        remuneraciones de CONNIKU (cierre día 22).
                        <br />
                        <br />
                        <span style={{ fontSize: 11, opacity: 0.8 }}>
                          El trabajador también puede consultarla en su perfil de la plataforma en
                          todo momento.
                        </span>
                      </p>
                    </div>
