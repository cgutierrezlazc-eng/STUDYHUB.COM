  ...
  useEffect(() => {
    ...
    const applyPayrollRecord = (records: any) => {
      const rec = Array.isArray(records)
        ? records.find((r: any) => r.employeeId === selectedEmp)
        : null;
    ...
    <div>
      ...
      <div className="card" style={{ padding: 20, marginBottom: 20 }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          ...
          <div>
            ...
            {desvSource && (
              ...
              >
                ✓ Sincronizado desde Desvinculación (Personas)
              </p>
            )}
          </div>
          <div>
            ...
            <input
              ...
              value={lastSalary}
              onChange={(e) => {
                setLastSalary(Number(e.target.value));
                setPayrollSource('manual');
              }}
              style={{
                width: '100%',
                padding: '8px 12px',
            ...
            >
              {payrollSource === 'payroll'
                ? '✓ Obtenido de última liquidación de nómina'
                : payrollSource === 'manual'
                  ? '✎ Modificado manualmente'
                  : '· Desde contrato del empleado (sin liquidación registrada)'}
            </p>
          </div>
          <FormField
          ...
          <div>
            ...
            >
              ...
              <span style={{ fontSize: 10, color: '#22c55e', fontWeight: 400 }}>
                (Art. 67 CT — calculado proporcional)
              </span>
            </label>
            <input
              type="number"
          ...
          <div>
            ...
            <p style={{ fontSize: 11, color: '#22c55e', margin: '4px 0 0' }}>
              ✓ Calculado desde fecha de término
            </p>
          </div>
        ...
        {desvSource && (
          ...
          >
            ✓ <strong>Datos sincronizados automáticamente</strong> desde el proceso de
            Desvinculación en Personas — revise y ajuste si es necesario antes de calcular.
          </div>
        )}
        ...
        <div className="card" style={{ padding: 20, border: '2px solid #ef4444' }}>
          ...
          <table style={{ width: '100%', fontSize: 14 }}>
            <tbody>
              ...
              <tr>
                <td>
                  Días trabajados del mes ({diasTrabajadosActual} días — hasta{' '}
                  {new Date(fechaTermino).toLocaleDateString('es-CL')})
                </td>
          ...
          >
            ...
            <br />
            {'\u2022'} Debe ser firmado ante un ministro de fe (notario, inspector del trabajo, o
