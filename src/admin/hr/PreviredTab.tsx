...
import { Building, Shield, Users, AlertTriangle, Download, Globe } from 'lucide-react';
      ...
      {!data || !data.employees?.length ? (
        ...
        <>
          ...
          <div style={{ display: 'flex', gap: 12, marginTop: 16 }}>
            <button
              style={btnPrimary}
              onClick={() => downloadPrevired(data, selectedMonth, selectedYear, months)}
            >
              <Download size={16} /> Descargar Planilla Previred
            </button>
            <button
              style={btnSecondary}
              onClick={() => window.open('https://previred.com', '_blank')}
            >
