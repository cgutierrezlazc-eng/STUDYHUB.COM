  ...
  const filteredBalances = balances.filter(
    (b) =>
      `${b.employee.firstName} ${b.employee.lastName}`
        .toLowerCase()
        .includes(searchTerm.toLowerCase()) || b.employee.rut.includes(searchTerm)
  );

  const filteredRequests = requests.filter(
    (r) => requestFilter === 'todas' || r.status === requestFilter
  );
  ...
  const handleCreateRequest = async () => {
    ...
    if (newRequest.type === 'vacaciones' && policy.requireMinConsecutiveDays && days < 10) {
      ...
      if (balance && balance.daysUsed === 0) {
        alert(
          'Art. 70 CT: La primera fraccion de vacaciones debe ser de al menos 10 dias habiles consecutivos.'
        );
        return;
      }
    }
  ...
  return (
    <div style={{ padding: '24px', maxWidth: 1400, margin: '0 auto' }}>
      ...
      >
        ...
        <button
          style={tabBtnStyle(activeTab === 'solicitudes')}
        ...
        <button
          style={tabBtnStyle(activeTab === 'calendario')}
          onClick={() => setActiveTab('calendario')}
        >
          <Calendar size={16} /> Calendario
        </button>
        <button
          style={tabBtnStyle(activeTab === 'configuracion')}
      ...
      {activeTab === 'saldos' && (
        <div>
                      ...
                      return (
                        <tr key={b.employee.id} style={{ borderBottom: '1px solid var(--border)' }}>
                          ...
                          <td style={{ ...tdStyle, textAlign: 'center' }}>
                            {formatDate(b.employee.hireDate)}
                          </td>
                          <td style={{ ...tdStyle, textAlign: 'center' }}>
          ...
          >
            <strong>Normativa aplicable:</strong> Art. 67 CT (15 dias base) | Art. 68 CT (progresivo
            desde 10 años) | Art. 69 CT (max 2 periodos acumulados, empleador puede forzar) | Art.
            70 CT (fraccionamiento, min 10 dias consecutivos) | Art. 73 CT (compensacion solo al
        ...
        <div>
              ...
              {(['todas', 'pendiente', 'aprobada', 'rechazada'] as const).map((f) => (
                <button
                  ...
                  style={{
                    ...
                    border:
                      requestFilter === f ? '1px solid var(--accent)' : '1px solid var(--border)',
                  }}
                >
            ...
            <div style={{ ...cardStyle, marginBottom: 20 }}>
              ...
              >
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setNewRequest((prev) => ({ ...prev, employeeId: e.target.value }))
                    }
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setNewRequest((prev) => ({ ...prev, type: e.target.value as LeaveType }))
                    }
                  >
                    {Object.entries(LEAVE_TYPE_LABELS).map(([key, label]) => {
                      if (key === 'dia_administrativo' && !policy.allowDiaAdministrativo)
                        return null;
                      return (
              ...
              {newRequest.startDate && newRequest.endDate && (
                ...
                >
                  <Clock size={14} />
                  <strong>
                    {countWorkingDays(newRequest.startDate, newRequest.endDate)} dias habiles
                  </strong>
              ...
              {newRequest.type === 'vacaciones' && (
                ...
                >
                  Art. 70 CT: Las vacaciones pueden fraccionarse, pero al menos una parte debe ser
                  de 10 dias habiles consecutivos.
                </div>
              )}
              {newRequest.type === 'permiso_legal' && (
                ...
                >
                  Ley 21.247: 5 dias habiles pagados por fallecimiento de conyuge, conviviente
                  civil, hijo o padre. El trabajador debe acreditar con certificado de defuncion.
                </div>
              )}
              {newRequest.type === 'paternidad' && (
                ...
                >
                  Art. 195 CT: 5 dias pagados por nacimiento de hijo. Se cuentan desde el dia del
                  parto.
                </div>
              )}
              {newRequest.type === 'licencia_medica' && (
                ...
                >
                  Las licencias medicas son administradas por Fonasa/Isapre. El empleador solo
                  registra para control interno.
                </div>
              )}

              <div style={{ display: 'flex', gap: 8, marginTop: 16, justifyContent: 'flex-end' }}>
                <button style={btnSecondary} onClick={() => setShowNewRequest(false)}>
                  Cancelar
                </button>
          ...
          <div style={{ ...cardStyle, padding: 0, overflow: 'hidden' }}>
            ...
            {filteredRequests.length === 0 && (
              <div style={{ padding: 32, textAlign: 'center', color: 'var(--text-muted)' }}>
                No hay solicitudes
                {requestFilter !== 'todas' ? ` con estado "${requestFilter}"` : ''}.
              </div>
            )}
          </div>
        </div>
        ...
        <div>
          ...
          >
            ...
            <h2 style={{ margin: 0, fontSize: 18, fontWeight: 700, textTransform: 'capitalize' }}>
              {new Date(calendarYear, calendarMonth).toLocaleDateString('es-CL', {
                month: 'long',
                year: 'numeric',
              })}
            </h2>
        ...
        >
          ...
          <div style={cardStyle}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              >
                ...
                <button
                  onClick={() =>
                    setPolicy((p) => ({ ...p, allowDiaAdministrativo: !p.allowDiaAdministrativo }))
                  }
                  style={{
                    width: 48,
                    height: 26,
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setPolicy((p) => ({
                        ...p,
                        diasAdministrativosPerYear: parseInt(e.target.value) || 1,
                      }))
                    }
              ...
              >
                <div>
                  <div style={{ fontWeight: 600, fontSize: 13 }}>
                    Validar Minimo 10 Dias Consecutivos
                  </div>
                  <div style={{ fontSize: 11, color: 'var(--text-muted)' }}>
                ...
                <button
                  onClick={() =>
                    setPolicy((p) => ({
                      ...p,
                      requireMinConsecutiveDays: !p.requireMinConsecutiveDays,
                    }))
                  }
                  style={{
                    width: 48,
                    ...
                    border: 'none',
                    cursor: 'pointer',
                    background: policy.requireMinConsecutiveDays
                      ? 'var(--accent)'
                      : 'var(--border)',
                    position: 'relative',
                    transition: 'background 0.2s',
          ...
          <div style={cardStyle}>
            ...
            <p style={{ fontSize: 12, color: 'var(--text-muted)', margin: '0 0 16px' }}>
              Art. 68 CT: Trabajadores con mas de 10 años de servicio (para uno o mas empleadores)
              tienen derecho a 1 dia adicional de vacaciones por cada 3 años nuevos de servicio.
            </p>
          ...
          <div style={cardStyle}>
            ...
            <p style={{ fontSize: 12, color: 'var(--text-muted)', margin: '0 0 16px' }}>
              Art. 69 CT: El empleador puede obligar al trabajador a tomar vacaciones si ha
              acumulado 2 periodos. Las vacaciones no tomadas no se pierden.
            </p>

            {balances.filter((b) => b.hasAccumulationAlert).length > 0 ? (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                {balances
                  .filter((b) => b.hasAccumulationAlert)
                  .map((b) => (
                    <div
                      key={b.employee.id}
                      style={{
                    ...
                    >
                      <div>
                        ...
                        <div style={{ fontSize: 11, color: '#b91c1c' }}>
                          {b.daysAvailable} dias acumulados — Excede limite de {b.totalEntitled * 2}{' '}
                          dias
                        </div>
                      </div>
          ...
          <div style={cardStyle}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {[
                {
                  art: 'Art. 67 CT',
                  desc: '15 dias habiles de vacaciones anuales despues de 1 año de servicio.',
                },
                {
                  art: 'Art. 68 CT',
                  desc: 'Vacaciones progresivas: +1 dia por cada 3 años nuevos despues de 10 años con uno o mas empleadores.',
                },
                {
                  art: 'Art. 69 CT',
                  desc: 'Maximo 2 periodos acumulados. El empleador puede forzar vacaciones si se excede.',
                },
                {
                  art: 'Art. 70 CT',
                  desc: 'Las vacaciones pueden fraccionarse por acuerdo. Una fraccion debe ser de al menos 10 dias habiles.',
                },
                {
                  art: 'Art. 73 CT',
                  desc: 'La compensacion en dinero de vacaciones solo procede al termino de la relacion laboral.',
                },
                {
                  art: 'Ley 21.247',
                  desc: '5 dias habiles pagados por fallecimiento de conyuge, conviviente civil, hijo o padre/madre.',
                },
                {
                  art: 'Art. 195 CT',
                  desc: '5 dias pagados de permiso de paternidad por nacimiento de un hijo.',
                },
              ].map((item) => (
                <div
                  key={item.art}
