...
export const ADMIN_MODULES: AdminModule[] = [
  ...
  { id: 'usuarios', label: 'Gestión de Usuarios', description: 'Todos los usuarios de la plataforma — colaboradores, estudiantes y roles', icon: 'users-cog', category: 'hr', route: '/admin-panel/hr/usuarios', status: 'active', isNew: true, ownerOnly: true },
