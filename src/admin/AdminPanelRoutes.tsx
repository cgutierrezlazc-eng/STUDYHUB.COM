    ...
    <Suspense fallback={<Loader />}>
      <Routes>
        ...
        <Route
          path="hr/personal"
          element={
            <Wrap title="Personas — People & Culture">
              <DirectorioPersonal />
            </Wrap>
          }
        />
        <Route
          path="hr/contratos"
          element={
            <Wrap title="Contratos y Vida Laboral">
              <ContratosTab />
            </Wrap>
          }
        />
        <Route
          path="hr/asistencia"
          element={
            <Wrap title="Asistencia y Jornada">
              <AsistenciaTab />
            </Wrap>
          }
        />
        <Route
          path="hr/vacaciones"
          element={
            <Wrap title="Vacaciones y Permisos">
              <VacacionesTab />
            </Wrap>
          }
        />
        ...
        <Route
          path="hr/onboarding"
          element={
            <Wrap title="Onboarding / Offboarding">
              <OnboardingTab />
            </Wrap>
          }
        />
        <Route
          path="hr/documentos"
          element={
            <Wrap title="Documentos del Trabajador">
              <DocumentosTab />
            </Wrap>
          }
        />
        <Route
          path="hr/desempeno"
          element={
            <Wrap title="Evaluación de Desempeño">
              <DesempenoTab />
            </Wrap>
          }
        />
        <Route
          path="hr/reclutamiento"
          element={
            <Wrap title="Reclutamiento">
              <ReclutamientoTab />
            </Wrap>
          }
        />
        <Route
          path="hr/capacitacion"
          element={
            <Wrap title="Capacitación / SENCE">
              <CapacitacionTab />
            </Wrap>
          }
        />
        ...
        <Route
          path="hr/usuarios"
          element={
            <Wrap title="Gestión de Usuarios">
              <GestionUsuarios onNavigate={onNavigate} />
            </Wrap>
          }
        />
        ...
        <Route
          path="payroll"
          element={
            <Wrap title="Remuneraciones">
              <PayrollModule />
            </Wrap>
          }
        />
        <Route
          path="payroll/liquidaciones"
          element={
            <Wrap title="Liquidaciones">
              <RemuneracionesTab />
            </Wrap>
          }
        />
        <Route
          path="payroll/previred"
          element={
            <Wrap title="Previred">
              <PreviredTab />
            </Wrap>
        ...
        />
        <Route
          path="payroll/finiquitos"
          element={
            <Wrap title="Finiquitos">
              <FiniquitosTab />
            </Wrap>
          }
        />
        <Route
          path="payroll/historial"
          element={
            <Wrap title="Historial de Pagos">
              <HistorialPagosTab />
            </Wrap>
          }
        />
        <Route
          path="payroll/libro-rem"
          element={
            <Wrap title="Libro de Remuneraciones">
              <LibroRemuneracionesTab />
            </Wrap>
          }
        />
        <Route
        ...
        />
        <Route
          path="payroll/impuestos"
          element={
            <Wrap title="Impuestos / F129">
              <ImpuestosTab />
            </Wrap>
          }
        />
        <Route
          path="payroll/inspeccion"
          element={
            <Wrap title="Inspección del Trabajo">
              <InspeccionTrabajoTab />
            </Wrap>
          }
        />
        ...
        <Route
          ...
          element={
            <Wrap title="Dashboard Ejecutivo">
              <CeoOverview onNavigate={onNavigate} />
            </Wrap>
          }
        />
        <Route
          path="finance/financiero"
          element={
            <Wrap title="Panel Financiero">
              <FinancialTab />
            </Wrap>
          }
        />
        <Route
          path="finance/gastos"
          element={
            <Wrap title="Gastos Operacionales">
              <GastosTab />
            </Wrap>
          }
        />
        <Route
          path="finance/contabilidad"
          element={
            <Wrap title="Contabilidad">
              <ContabilidadTab />
            </Wrap>
          }
        />
        <Route
          path="finance/facturacion"
          element={
            <Wrap title="Facturación / DTE">
              <FacturacionTab />
            </Wrap>
          }
        />
        <Route
          path="finance/presupuestos"
          element={
            <Wrap title="Presupuestos">
              <PresupuestosTab />
            </Wrap>
          }
        />
        ...
        {/* Tools */}
        <Route
          path="tools/email-ceo"
          element={
            <Wrap title="Email CEO">
              <CeoEmailModule onNavigate={onNavigate} />
            </Wrap>
          }
        />
        <Route
          path="tools/email-contacto"
          element={
            <Wrap title="Email Contacto">
              <ContactoEmailModule onNavigate={onNavigate} />
            </Wrap>
          }
        />
        <Route
          path="tools/certificaciones"
          element={
            <Wrap title="Certificaciones">
              <CertificationsModule />
            </Wrap>
          }
        />
        <Route
          path="tools/ai-workflows"
          element={
            <Wrap title="Workflows">
              <AIWorkflowsModule onNavigate={onNavigate} />
            </Wrap>
          }
        />
        <Route
        ...
        <Route
          path="tools/push"
          element={
            <Wrap title="Push Notifications">
              <PushNotificationsModule />
            </Wrap>
          }
        />
        <Route
          path="tools/guia-owner"
          element={
            <Wrap title="Guía del Owner">
              <OwnerGuideTab />
            </Wrap>
          }
        />
        <Route
          path="tools/biblioteca"
          element={
            <Wrap title="Biblioteca de Documentos">
