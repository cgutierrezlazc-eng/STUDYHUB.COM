...
- **Total de bloques cerrados:** 3 completos (bloque-1, bloque-2-workspaces-v1, bloque-hardening-quizzes-c3) + 2 sub-bloques históricos (2a + 2b del bloque-2)
- **Promedio de iteraciones por bloque:** 0.8 (bloque-1: 1, bloque-2-v1: 1, hardening-quizzes-c3: 1, 2a: 1, 2b: 0)
- **Tiempo promedio de cierre (desde inicio hasta OK):** <48h
- **Bloques con componente legal:** 1 (bloque-1). bloque-2-v1 tiene componente legal parcial (Privacy v2.3 publicada 2026-04-19, T&C diferido a bloque legal-consolidation-v2). hardening-quizzes-c3 sin componente legal.
