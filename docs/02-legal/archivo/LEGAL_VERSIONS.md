...
**Bloque activo**: bloque-contact-tickets-v1
...
| Privacy Policy | 2.4.0 | 7a8ba81d0be2 | 2026-04-20 | 2026-04-22 | `v3.2/privacy.md` (superseded in-place por 2.4.1) |
| Privacy Policy | 2.4.1 | b5b9fed8fd5e | 2026-04-22 | actual | `v3.2/privacy.md` |
...
- **Aprobación pendiente**: Privacy v2.4.0, Privacy v2.4.1 y Terms v3.2.0 están redactados pero pendientes de validación por abogado externo antes de marcar `aprobacion_fecha` en `v3.2/METADATA.yaml`. Gate humano §18.7 CLAUDE.md.
- **Privacy v2.4.1 (2026-04-22)**: bump desde v2.4.0 por bloque `bloque-contact-tickets-v1` (decisión Cristian 2026-04-22 Opción A: bump en el mismo PR del bloque). Cambios: nueva Sección 2bis "Sistema de tickets de contacto" con detalle de datos recolectados, base legal Art. 6(1)(a) GDPR + Ley 19.628 Art. 4° (consentimiento en el envío) más Art. 6(1)(f) GDPR (interés legítimo para metadatos técnicos y anti-abuso), enrutamiento por motivo declarando estado real (todos llegan hoy a `contacto@` y se declara destino futuro `prensa@`/`legal@`/`seguridad@` pendiente de provisión en Zoho), medidas técnicas (rate-limit 5/h/IP, honeypot, re-validación de hash de consentimiento GDPR Art. 7(1)), bidireccionalidad con remitente `noreply@conniku.com` y `Reply-To: contacto@conniku.com`, retención 5 años fundada en Art. 17(3)(e) GDPR + Art. 2515 Código Civil Chile + Ley 19.496 Art. 50. §6 encargados: Zoho Mail ampliado como encargado Art. 28 GDPR para el canal email con DPA oficial <https://www.zoho.com/gdpr.html>. §9 añade línea de retención tickets. §11.1 historial de versiones. §14 transferencias internacionales menciona infraestructura Zoho. Hash anterior `7a8ba81d0be22cc1deee7d92764baaac1a598a662b84d9ba90043b2a25f63f6c`; hash nuevo `b5b9fed8fd5e4e600c7fa33fbd8dddaec5c627be189b5382e8b7cf81dbcfa288`. Consecuencia probatoria: cuando `LEGAL_GATE_ENFORCE=true` en Render, los usuarios con consentimiento apuntando al hash anterior quedan obligados a re-aceptar; esto es el comportamiento esperado y es correcto conforme a GDPR Art. 7(1). Aprobación por abogado pendiente (gate humano §18.7 CLAUDE.md).
