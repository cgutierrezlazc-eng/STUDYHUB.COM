...
- Nota técnica (v3.2): tras análisis realizado en la auditoría legal externa del 2026-04-20 (hallazgo H-37), se verificó que el Art. 210 del Código Penal chileno **no aplica** al checkbox declarativo de registro privado de Conniku. El tipo penal exige que la declaración falsa se preste "ante la autoridad o sus agentes", y Conniku SpA no tiene carácter de autoridad ni de agente público. Por esta razón, se mantiene la fórmula genérica "responsabilidad civil y penal según la legislación vigente" en el texto visible al usuario, sin cita de artículo específico. La nota previa que marcaba este punto como "pendiente de validación por abogado" se cierra con esta aclaración.
